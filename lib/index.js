...
import AdaBoost from './model/adaboost.js'
...
import ARIMA from './model/arima.js'
...
import CartesianGeneticProgramming from './model/cgp.js'
...
import COPKMeans from './model/cop_kmeans.js'
import COPOD from './model/copod.js'
...
import DDPGAgent from './model/ddpg.js'
...
import { DEMA } from './model/dema.js'
...
import DUOL from './model/duol.js'
...
import EPMA from './model/epma.js'
...
import GeneticProgramming from './model/genetic_programming.js'
...
import JarvisPatrickClustering from './model/jarvis_patrick_clustering.js'
import KalmanFilter from './model/kalman_filter.js'
import KAMA from './model/kama.js'
...
import MesaAdaptiveMovingAverage from './model/mama.js'
...
import T3MovingAverage from './model/t3_moving_average.js'
...
import ZeroR from './model/zeror.js'
...
export default {
	 ...
	 * @property {AdaBoost} AdaBoost (Discrete) Adaptive Boosting
	 ...
	 * @property {ARIMA} ARIMA AutoRegressive Integrated Moving Average model
	 ...
	 * @property {CartesianGeneticProgramming} CartesianGeneticProgramming Cartesian genetic programming
	 ...
	 * @property {COPKMeans} COPKMeans Constrained K-means Algorithm
	 * @property {COPOD} COPOD COPula-based Outlier Detector
	 ...
	 * @property {DDPGAgent} DDPGAgent Deep Deterministic Policy Gradient agent
	 ...
	 * @property {DEMA} DEMA Double exponential moving average
	 ...
	 * @property {DUOL} DUOL Double Updating Approach for Online Learning
	 ...
	 * @property {EPMA} EPMA Endpoint moving average / Linear Regression Indicator
	 ...
	 * @property {GeneticProgramming} GeneticProgramming Genetic Programming
	 ...
	 * @property {HBOS} HBOS Histogram-based Outlier Score
	 ...
	 * @property {HullMovingAverage} HullMovingAverage Hull moving average
	 ...
	 * @property {JarvisPatrickClustering} JarvisPatrickClustering Jarvis Patrick Clustering
	 * @property {KalmanFilter} KalmanFilter Kalman filter
	 * @property {KAMA} KAMA Kaufman's Adaptive Moving Average
	 ...
	 * @property {MesaAdaptiveMovingAverage} MesaAdaptiveMovingAverage MESA Adaptive Moving Average / Following Adaptive Moving Average
	 ...
	 * @property {T3MovingAverage} T3MovingAverage T3 moving average
	 * @property {TEMA} TEMA Triple exponential moving average
	 ...
	 * @property {WeightedBlurringMeanShift} WeightedBlurringMeanShift Weighted Blurring Mean shift
	 ...
	 * @property {YinyangKMeans} YinyangKMeans Yinyang k-Means algorithm
	 * @property {ZeroR} ZeroR Zero Rule
	 * @property {ZeroInflatedNegativeBinomial} ZeroInflatedNegativeBinomial Zero-inflated negative binomial
	...
	models: {
		...
		MovingMedian,
		MT,
		MultivariateKernelDensityEstimator,
	 ...
	 * @property {RLStepResult} RLStepResult
	 ...
	 * @property {GemPuzzleRLEnvironment} GemPuzzleRLEnvironment Gem puzzle environment
