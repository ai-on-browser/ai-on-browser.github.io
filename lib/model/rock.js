...
export default class ROCK {
	...
	_g(c1, c2, links) {
		const v1 = this._leafs(c1)
		const v2 = this._leafs(c2)
	 ...
	 * @returns {{point?: number[], index?: number, g: number, distance?: number, children?: *[]}[]} Cluster nodes
	 */
	getClusters(number) {
