...
export class CELLIP {
	...
	/**
	 * @param {number} [gamma=0.1] Desired classification margin
	 * @param {number} [a=0.5] Tradeoff parameter
	 */
...
export class IELLIP {
	...
	/**
	 * @param {number} [b=0.9] Parameter controlling the memory of online learning
	 * @param {number} [c=0.5] Parameter controlling the memory of online learning
	 */
