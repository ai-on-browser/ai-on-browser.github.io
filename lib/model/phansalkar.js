...
export default class PhansalkarThresholding {
	...
	/**
	 * @param {number} [n=3] Size of local range
	 * @param {number} [k=0.25] Tuning parameter
	 * @param {number} [r=0.5] Tuning parameter
	 * @param {number} [p=2] Tuning parameter
	 * @param {number} [q=10] Tuning parameter
	 */
