...
export default class BIRCH {
	...
	/**
	 * @param {number} k
	 * @param {number} [b=10] Maximum number of entries for each non-leaf nodes
	 * @param {number} [t=0.2] Threshold
	 * @param {number} [l=Infinity] Maximum number of entries for each leaf nodes
	 */
