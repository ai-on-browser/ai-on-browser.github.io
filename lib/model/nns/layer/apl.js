...
export default class AdaptivePiecewiseLinearLayer extends Layer {
	 ...
	 * @param {number} [config.s=2] Number of hinges
	 * @param {number | number[]} [config.a=0.1] Variables control the slopes of the linear segments
	 * @param {number | number[]} [config.b=0] Variables determine the locations of the hinges
	 */
