 ...
 * { type: 'argmax', axis?: number, keepdims?: boolean } |
 * { type: 'argmin', axis?: number, keepdims?: boolean } |
 * { type: 'asin' } |
 * { type: 'asinh' } |
 * { type: 'atan' } |
 * { type: 'atanh' } |
 ...
 * { type: 'ceil' } |
 * { type: 'celu', a?: number } |
 * { type: 'clip', min?: number | string, max?: number | string } |
 * { type: 'cloglog' } |
 * { type: 'cloglogm' } |
 ...
 * { type: 'graph_conv', out_size: number, w?: number[][] | Matrix | string, b?: number[][] | Matrix | string, activation?: string | object, l2_decay?: number, l1_decay?: number } |
 * { type: 'graph_sage', out_size: number, aggregate?: 'mean', w?: number[][] | Matrix | string, b?: number[][] | Matrix | string, activation?: string | object, l2_decay?: number, l1_decay?: number } |
 * { type: 'greater' } |
 ...
 * { type: 'mean', axis?: number | number[] | string, keepdims?: boolean } |
 * { type: 'min' } |
 * { type: 'mish' } |
 * { type: 'mod' } |
 ...
 * { type: 'prod', axis?: number | number[] | string, keepdims?: boolean } |
 * { type: 'psf', m?: number } |
 * { type: 'ptanh', a?: number } |
 * { type: 'ptelu', alpha?: number, beta?: number } |
 * { type: 'random', size: number | number[] | string, mean?: number, variance?: number } |
 * { type: 'readout', method?: 'sum' | 'mean' } |
 * { type: 'reciprocal' } |
 * { type: 'reduce_max', axis?: number | number[] | string, keepdims?: boolean } |
 * { type: 'reduce_min', axis?: number | number[] | string, keepdims?: boolean } |
 * { type: 'relu' } |
 * { type: 'repu', s?: number } |
 * { type: 'resech' } |
 ...
 * { type: 'softmax', axis?: number } |
 * { type: 'softmin', axis?: number } |
 * { type: 'softplus', beta?: number } |
 * { type: 'softsign' } |
 * { type: 'sparsity', rho: number, beta: number } |
 * { type: 'spike_encoding', size: number, method?: string, max_freq?: number, dt?: number } |
 * { type: 'spike_lif', size: number, w?: number[][] | Matrix | string, th?: number, spike_train_dim?: number } |
 ...
 * { type: 'std', axis?: number | number[] | string, keepdims?: boolean } |
 * { type: 'sub' } |
 * { type: 'sum', axis?: number | number[] | string, keepdims?: boolean } |
 * { type: 'supervisor' } |
