...
export { default as LinearLayer } from './linear.js'
 ...
 * { type: 'conv', kernel: number | number[], channel?: number, stride?: number | number[], padding?: number | number[], w?: number[][] | Tensor, activation?: string, l2_decay?: number, l1_decay?: number, activation_params?: object, channel_dim?: number } |
 * { type: 'cos' } |
 * { type: 'cosh' } |
 * { type: 'crelu' } |
 * { type: 'detach' } |
 ...
 * { type: 'floor' } |
 * { type: 'frelu', b?: number } |
 * { type: 'full', out_size: number | string, w?: number[][] | Matrix, b?: number[][] | Matrix, activation?: string, l2_decay?: number, l1_decay?: number, activation_params?: object } |
 * { type: 'gaussian' } |
 * { type: 'geru' } |
 ...
 * { type: 'variable', size: number[], l2_decay?: number, l1_decay?: number, value?: number[] | number[][] | Tensor } |
