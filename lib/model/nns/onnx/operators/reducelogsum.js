...
/**
 * Handle reduce log sum operator
 *
 * @module HandleONNXReduceLogSumOperator
 * @see https://github.com/onnx/onnx/blob/main/docs/Operators.md#ReduceLogSum
 */
export default {
	/**
	...
	import(model, node) {
		...
		return [
			...
			{ type: 'log', name: node.outputList[0] },
		]
	},
}
