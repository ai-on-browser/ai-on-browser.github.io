...
/**
 * Handle reduce L2 operator
 *
 * @module HandleONNXReduceL2Operator
 * @see https://github.com/onnx/onnx/blob/main/docs/Operators.md#ReduceL2
 */
export default {
	/**
	...
	import(model, node) {
		...
		return [
			{ type: 'square', input: [node.inputList[0]] },
			{ type: 'sum', axis: initializers.axis || node.inputList[1] || -1, keepdims: !!attrs.keepdims },
			{ type: 'sqrt', name: node.outputList[0] },
		]
	},
}
