...
var require_google_protobuf = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	}, e = "undefined" != typeof window && window === exports ? exports : "undefined" != typeof global && null != global ? global : exports;
	function ba(a, b) {
		if (b) {
			var c = e;
			a = a.split(".");
	...
	J.prototype.C = function() {
		switch (this.b) {
			...
			case 3:
				this.jb();
				break;
			default: p("Invalid wire encoding for field.");
		}
	};
	...
	S.prototype.ua = function(a) {
		n(a == Math.floor(a));
		n(-0x8000000000000000 <= a && 0x8000000000000000 > a);
		A(a);
		this.l(y, z);
	};
	...
	W.prototype.Nc = function(a, b, c) {
		switch (a) {
			...
			case 31:
				this.N(b, c);
				break;
			default: p("Invalid field type in writeAny()");
		}
	};
	...
	W.prototype.T = function(a, b) {
		null != b && (n(-0x8000000000000000 <= b && 0x8000000000000000 > b), null != b && (Y(this, a, 0), this.a.ua(b)));
	};
	...
	W.prototype.V = function(a, b) {
		null != b && (n(0 <= b && 0x10000000000000000 > b), null != b && (Y(this, a, 0), this.a.va(b)));
	};
	...
	W.prototype.sb = function(a, b) {
		null != b && (n(-0x8000000000000000 <= b && 0x8000000000000000 > b), null != b && (Y(this, a, 0), this.a.xa(b)));
	};
	...
	W.prototype.Qa = function(a, b) {
		null != b && (n(0 <= b && 0x10000000000000000 > b), Y(this, a, 1), this.a.V(b));
	};
	...
	W.prototype.Sa = function(a, b) {
		null != b && (n(-0x8000000000000000 <= b && 0x8000000000000000 > b), Y(this, a, 1), this.a.T(b));
	};
...
//#endregion
//#region onnx_pb.js
var require_onnx_pb = /* @__PURE__ */ __commonJSMin(((exports) => {
	/**
	* @fileoverview
	* @enhanceable
	...
	*/
	...
	goog.exportSymbol("proto.onnx.DeviceConfigurationProto", null, global);
	goog.exportSymbol("proto.onnx.FunctionProto", null, global);
	goog.exportSymbol("proto.onnx.GraphProto", null, global);
	goog.exportSymbol("proto.onnx.IntIntListEntryProto", null, global);
	goog.exportSymbol("proto.onnx.ModelProto", null, global);
	goog.exportSymbol("proto.onnx.NodeDeviceConfigurationProto", null, global);
	...
	goog.exportSymbol("proto.onnx.ShardedDimProto", null, global);
	goog.exportSymbol("proto.onnx.ShardingSpecProto", null, global);
	goog.exportSymbol("proto.onnx.SimpleShardedDimProto", null, global);
	goog.exportSymbol("proto.onnx.SimpleShardedDimProto.DimCase", null, global);
 ...
 /**
	...
	* @constructor
	*/
	proto.onnx.IntIntListEntryProto = function(opt_data) {
		jspb.Message.initialize(this, opt_data, 0, -1, proto.onnx.IntIntListEntryProto.repeatedFields_, null);
	};
	goog.inherits(proto.onnx.IntIntListEntryProto, jspb.Message);
	if (goog.DEBUG && !COMPILED)
 /**
	* @public
	* @override
	*/
	proto.onnx.IntIntListEntryProto.displayName = "proto.onnx.IntIntListEntryProto";
	/**
	* Generated by JsPbCodeGenerator.
	* @param {Array=} opt_data Optional initial data array, typically from a
	* server response, or constructed directly in Javascript. The array is used
	...
	* @constructor
	*/
	proto.onnx.NodeDeviceConfigurationProto = function(opt_data) {
		jspb.Message.initialize(this, opt_data, 0, -1, proto.onnx.NodeDeviceConfigurationProto.repeatedFields_, null);
	};
	goog.inherits(proto.onnx.NodeDeviceConfigurationProto, jspb.Message);
	if (goog.DEBUG && !COMPILED)
 /**
	* @public
	* @override
	*/
	proto.onnx.NodeDeviceConfigurationProto.displayName = "proto.onnx.NodeDeviceConfigurationProto";
	/**
	* Generated by JsPbCodeGenerator.
	* @param {Array=} opt_data Optional initial data array, typically from a
	* server response, or constructed directly in Javascript. The array is used
	...
	* @constructor
	*/
	proto.onnx.ShardingSpecProto = function(opt_data) {
		jspb.Message.initialize(this, opt_data, 0, -1, proto.onnx.ShardingSpecProto.repeatedFields_, null);
	};
	goog.inherits(proto.onnx.ShardingSpecProto, jspb.Message);
	if (goog.DEBUG && !COMPILED)
 /**
	* @public
	* @override
	*/
	proto.onnx.ShardingSpecProto.displayName = "proto.onnx.ShardingSpecProto";
	/**
	* Generated by JsPbCodeGenerator.
	* @param {Array=} opt_data Optional initial data array, typically from a
	* server response, or constructed directly in Javascript. The array is used
	...
	* @constructor
	*/
	proto.onnx.ShardedDimProto = function(opt_data) {
		jspb.Message.initialize(this, opt_data, 0, -1, proto.onnx.ShardedDimProto.repeatedFields_, null);
	};
	goog.inherits(proto.onnx.ShardedDimProto, jspb.Message);
	if (goog.DEBUG && !COMPILED)
 /**
	* @public
	* @override
	*/
	proto.onnx.ShardedDimProto.displayName = "proto.onnx.ShardedDimProto";
	/**
	* Generated by JsPbCodeGenerator.
	* @param {Array=} opt_data Optional initial data array, typically from a
	* server response, or constructed directly in Javascript. The array is used
	...
	* @constructor
	*/
	proto.onnx.SimpleShardedDimProto = function(opt_data) {
		jspb.Message.initialize(this, opt_data, 0, -1, null, proto.onnx.SimpleShardedDimProto.oneofGroups_);
	};
	goog.inherits(proto.onnx.SimpleShardedDimProto, jspb.Message);
	if (goog.DEBUG && !COMPILED)
 /**
	* @public
	* @override
	*/
	proto.onnx.SimpleShardedDimProto.displayName = "proto.onnx.SimpleShardedDimProto";
	/**
	* Generated by JsPbCodeGenerator.
	* @param {Array=} opt_data Optional initial data array, typically from a
	* server response, or constructed directly in Javascript. The array is used
 ...
 /**
	...
	* @constructor
	*/
	proto.onnx.DeviceConfigurationProto = function(opt_data) {
		jspb.Message.initialize(this, opt_data, 0, -1, proto.onnx.DeviceConfigurationProto.repeatedFields_, null);
	};
	goog.inherits(proto.onnx.DeviceConfigurationProto, jspb.Message);
	if (goog.DEBUG && !COMPILED)
 /**
	* @public
	* @override
	*/
	proto.onnx.DeviceConfigurationProto.displayName = "proto.onnx.DeviceConfigurationProto";
	/**
	* Generated by JsPbCodeGenerator.
	* @param {Array=} opt_data Optional initial data array, typically from a
	* server response, or constructed directly in Javascript. The array is used
 ...
 /**
	...
	* @const
	*/
	proto.onnx.AttributeProto.repeatedFields_ = [
		7,
		8,
		9,
		10,
	...
	if (jspb.Message.GENERATE_TO_OBJECT) {
		...
		*/
		proto.onnx.AttributeProto.toObject = function(includeInstance, msg) {
			var f, obj = {
				name: (f = jspb.Message.getField(msg, 1)) == null ? void 0 : f,
				refAttrName: (f = jspb.Message.getField(msg, 21)) == null ? void 0 : f,
				docString: (f = jspb.Message.getField(msg, 13)) == null ? void 0 : f,
				type: (f = jspb.Message.getField(msg, 20)) == null ? void 0 : f,
				f: (f = jspb.Message.getOptionalFloatingPointField(msg, 2)) == null ? void 0 : f,
				i: (f = jspb.Message.getField(msg, 3)) == null ? void 0 : f,
				s: msg.getS_asB64(),
				...
				floatsList: (f = jspb.Message.getRepeatedFloatingPointField(msg, 7)) == null ? void 0 : f,
				intsList: (f = jspb.Message.getRepeatedField(msg, 8)) == null ? void 0 : f,
				stringsList: msg.getStringsList_asB64(),
				tensorsList: jspb.Message.toObjectList(msg.getTensorsList(), proto.onnx.TensorProto.toObject, includeInstance),
				graphsList: jspb.Message.toObjectList(msg.getGraphsList(), proto.onnx.GraphProto.toObject, includeInstance),
				sparseTensorsList: jspb.Message.toObjectList(msg.getSparseTensorsList(), proto.onnx.SparseTensorProto.toObject, includeInstance),
				typeProtosList: jspb.Message.toObjectList(msg.getTypeProtosList(), proto.onnx.TypeProto.toObject, includeInstance)
			};
		...
		while (reader.nextField()) {
			...
			switch (reader.getFieldNumber()) {
				...
				case 14:
					...
					break;
				case 7:
					var values = reader.isDelimited() ? reader.readPackedFloat() : [reader.readFloat()];
					for (var i = 0; i < values.length; i++) msg.addFloats(values[i]);
					break;
				case 8:
					var values = reader.isDelimited() ? reader.readPackedInt64() : [reader.readInt64()];
					for (var i = 0; i < values.length; i++) msg.addInts(values[i]);
					break;
				case 9:
					var value = reader.readBytes();
	...
	*/
	proto.onnx.AttributeProto.serializeBinaryToWriter = function(message, writer) {
		...
		if (f != null) writer.writeString(21, f);
		f = jspb.Message.getField(message, 13);
		if (f != null) writer.writeString(13, f);
		f = jspb.Message.getField(message, 20);
		if (f != null) writer.writeEnum(20, f);
		...
		if (f != null) writer.writeBytes(4, f);
		f = message.getT();
		if (f != null) writer.writeMessage(5, f, proto.onnx.TensorProto.serializeBinaryToWriter);
		f = message.getG();
		if (f != null) writer.writeMessage(6, f, proto.onnx.GraphProto.serializeBinaryToWriter);
		f = message.getSparseTensor();
		if (f != null) writer.writeMessage(22, f, proto.onnx.SparseTensorProto.serializeBinaryToWriter);
		f = message.getTp();
		if (f != null) writer.writeMessage(14, f, proto.onnx.TypeProto.serializeBinaryToWriter);
		f = message.getFloatsList();
		if (f.length > 0) writer.writeRepeatedFloat(7, f);
		f = message.getIntsList();
		if (f.length > 0) writer.writeRepeatedInt64(8, f);
		f = message.getStringsList_asU8();
		if (f.length > 0) writer.writeRepeatedBytes(9, f);
		f = message.getTensorsList();
		if (f.length > 0) writer.writeRepeatedMessage(10, f, proto.onnx.TensorProto.serializeBinaryToWriter);
		f = message.getGraphsList();
		if (f.length > 0) writer.writeRepeatedMessage(11, f, proto.onnx.GraphProto.serializeBinaryToWriter);
		f = message.getSparseTensorsList();
		if (f.length > 0) writer.writeRepeatedMessage(23, f, proto.onnx.SparseTensorProto.serializeBinaryToWriter);
		f = message.getTypeProtosList();
		if (f.length > 0) writer.writeRepeatedMessage(15, f, proto.onnx.TypeProto.serializeBinaryToWriter);
	};
	/**
	* @enum {number}
	*/
	...
	*/
	proto.onnx.AttributeProto.prototype.clearRefAttrName = function() {
		return jspb.Message.setField(this, 21, void 0);
	};
	/**
	* Returns whether this field is set.
	* @return {boolean}
	...
	*/
	proto.onnx.AttributeProto.prototype.getS_asB64 = function() {
		return jspb.Message.bytesAsB64(this.getS());
	};
	/**
	* optional bytes s = 4;
	...
	*/
	proto.onnx.AttributeProto.prototype.getS_asU8 = function() {
		return jspb.Message.bytesAsU8(this.getS());
	};
	/**
	...
	*/
	proto.onnx.AttributeProto.prototype.getT = function() {
		return jspb.Message.getWrapperField(this, proto.onnx.TensorProto, 5);
	};
	/**
	...
	*/
	proto.onnx.AttributeProto.prototype.getG = function() {
		return jspb.Message.getWrapperField(this, proto.onnx.GraphProto, 6);
	};
	/**
	...
	*/
	proto.onnx.AttributeProto.prototype.getSparseTensor = function() {
		return jspb.Message.getWrapperField(this, proto.onnx.SparseTensorProto, 22);
	};
	/**
	...
	*/
	proto.onnx.AttributeProto.prototype.clearSparseTensor = function() {
		return this.setSparseTensor(void 0);
	};
	/**
	* Returns whether this field is set.
	* @return {boolean}
	...
	*/
	proto.onnx.AttributeProto.prototype.getTp = function() {
		return jspb.Message.getWrapperField(this, proto.onnx.TypeProto, 14);
	};
	/**
	...
	*/
	proto.onnx.AttributeProto.prototype.getFloatsList = function() {
		return jspb.Message.getRepeatedFloatingPointField(this, 7);
	};
	/**
	...
	*/
	proto.onnx.AttributeProto.prototype.getStringsList_asB64 = function() {
		return jspb.Message.bytesListAsB64(this.getStringsList());
	};
	/**
	* repeated bytes strings = 9;
	* Note that Uint8Array is not supported on all browsers.
	...
	*/
	proto.onnx.AttributeProto.prototype.getStringsList_asU8 = function() {
		return jspb.Message.bytesListAsU8(this.getStringsList());
	};
	/**
	...
	*/
	proto.onnx.AttributeProto.prototype.getTensorsList = function() {
		return jspb.Message.getRepeatedWrapperField(this, proto.onnx.TensorProto, 10);
	};
	/**
	...
	*/
	proto.onnx.AttributeProto.prototype.getGraphsList = function() {
		return jspb.Message.getRepeatedWrapperField(this, proto.onnx.GraphProto, 11);
	};
	/**
	...
	*/
	proto.onnx.AttributeProto.prototype.getSparseTensorsList = function() {
		return jspb.Message.getRepeatedWrapperField(this, proto.onnx.SparseTensorProto, 23);
	};
	/**
	...
	*/
	proto.onnx.AttributeProto.prototype.getTypeProtosList = function() {
		return jspb.Message.getRepeatedWrapperField(this, proto.onnx.TypeProto, 15);
	};
	/**
		...
		*/
		proto.onnx.ValueInfoProto.toObject = function(includeInstance, msg) {
			var f, obj = {
				...
				docString: (f = jspb.Message.getField(msg, 3)) == null ? void 0 : f,
				metadataPropsList: jspb.Message.toObjectList(msg.getMetadataPropsList(), proto.onnx.StringStringEntryProto.toObject, includeInstance)
			};
			if (includeInstance) obj.$jspbMessageInstance = msg;
			return obj;
		};
	...
	*/
	proto.onnx.ValueInfoProto.serializeBinaryToWriter = function(message, writer) {
		...
		if (f != null) writer.writeString(1, f);
		f = message.getType();
		if (f != null) writer.writeMessage(2, f, proto.onnx.TypeProto.serializeBinaryToWriter);
		f = jspb.Message.getField(message, 3);
		if (f != null) writer.writeString(3, f);
		f = message.getMetadataPropsList();
		if (f.length > 0) writer.writeRepeatedMessage(4, f, proto.onnx.StringStringEntryProto.serializeBinaryToWriter);
	};
	/**
	* optional string name = 1;
	* @return {string}
	...
	*/
	proto.onnx.ValueInfoProto.prototype.getType = function() {
		return jspb.Message.getWrapperField(this, proto.onnx.TypeProto, 2);
	};
	/**
	* @param {?proto.onnx.TypeProto|undefined} value
	* @return {!proto.onnx.ValueInfoProto} returns this
	...
	*/
	proto.onnx.ValueInfoProto.prototype.getMetadataPropsList = function() {
		return jspb.Message.getRepeatedWrapperField(this, proto.onnx.StringStringEntryProto, 4);
	};
	/**
	...
	* @const
	*/
	proto.onnx.NodeProto.repeatedFields_ = [
		1,
		2,
		5,
		9,
	...
	if (jspb.Message.GENERATE_TO_OBJECT) {
		...
		*/
		proto.onnx.NodeProto.toObject = function(includeInstance, msg) {
			var f, obj = {
				inputList: (f = jspb.Message.getRepeatedField(msg, 1)) == null ? void 0 : f,
				outputList: (f = jspb.Message.getRepeatedField(msg, 2)) == null ? void 0 : f,
				name: (f = jspb.Message.getField(msg, 3)) == null ? void 0 : f,
				opType: (f = jspb.Message.getField(msg, 4)) == null ? void 0 : f,
				domain: (f = jspb.Message.getField(msg, 7)) == null ? void 0 : f,
				overload: (f = jspb.Message.getField(msg, 8)) == null ? void 0 : f,
				attributeList: jspb.Message.toObjectList(msg.getAttributeList(), proto.onnx.AttributeProto.toObject, includeInstance),
				docString: (f = jspb.Message.getField(msg, 6)) == null ? void 0 : f,
				metadataPropsList: jspb.Message.toObjectList(msg.getMetadataPropsList(), proto.onnx.StringStringEntryProto.toObject, includeInstance),
				deviceConfigurationsList: jspb.Message.toObjectList(msg.getDeviceConfigurationsList(), proto.onnx.NodeDeviceConfigurationProto.toObject, includeInstance)
			};
			if (includeInstance) obj.$jspbMessageInstance = msg;
			return obj;
		};
		...
		while (reader.nextField()) {
			...
			switch (reader.getFieldNumber()) {
				...
				case 9:
					...
					break;
				case 10:
					var value = new proto.onnx.NodeDeviceConfigurationProto();
					reader.readMessage(value, proto.onnx.NodeDeviceConfigurationProto.deserializeBinaryFromReader);
					msg.addDeviceConfigurations(value);
					break;
				default:
					reader.skipField();
					break;
	...
	*/
	proto.onnx.NodeProto.serializeBinaryToWriter = function(message, writer) {
		...
		if (f != null) writer.writeString(3, f);
		f = jspb.Message.getField(message, 4);
		if (f != null) writer.writeString(4, f);
		f = jspb.Message.getField(message, 7);
		if (f != null) writer.writeString(7, f);
		f = jspb.Message.getField(message, 8);
		if (f != null) writer.writeString(8, f);
		f = message.getAttributeList();
		if (f.length > 0) writer.writeRepeatedMessage(5, f, proto.onnx.AttributeProto.serializeBinaryToWriter);
		f = jspb.Message.getField(message, 6);
		if (f != null) writer.writeString(6, f);
		f = message.getMetadataPropsList();
		if (f.length > 0) writer.writeRepeatedMessage(9, f, proto.onnx.StringStringEntryProto.serializeBinaryToWriter);
		f = message.getDeviceConfigurationsList();
		if (f.length > 0) writer.writeRepeatedMessage(10, f, proto.onnx.NodeDeviceConfigurationProto.serializeBinaryToWriter);
	};
	/**
	...
	*/
	proto.onnx.NodeProto.prototype.getAttributeList = function() {
		return jspb.Message.getRepeatedWrapperField(this, proto.onnx.AttributeProto, 5);
	};
	/**
	...
	*/
	proto.onnx.NodeProto.prototype.getMetadataPropsList = function() {
		return jspb.Message.getRepeatedWrapperField(this, proto.onnx.StringStringEntryProto, 9);
	};
	/**
	* @param {!Array<!proto.onnx.StringStringEntryProto>} value
	* @return {!proto.onnx.NodeProto} returns this
	...
	* @return {!Array<!proto.onnx.NodeDeviceConfigurationProto>}
	*/
	proto.onnx.NodeProto.prototype.getDeviceConfigurationsList = function() {
		return jspb.Message.getRepeatedWrapperField(this, proto.onnx.NodeDeviceConfigurationProto, 10);
	};
	/**
	* @param {!Array<!proto.onnx.NodeDeviceConfigurationProto>} value
	* @return {!proto.onnx.NodeProto} returns this
	*/
	proto.onnx.NodeProto.prototype.setDeviceConfigurationsList = function(value) {
		return jspb.Message.setRepeatedWrapperField(this, 10, value);
	};
	/**
	* @param {!proto.onnx.NodeDeviceConfigurationProto=} opt_value
	* @param {number=} opt_index
	* @return {!proto.onnx.NodeDeviceConfigurationProto}
	*/
	proto.onnx.NodeProto.prototype.addDeviceConfigurations = function(opt_value, opt_index) {
		return jspb.Message.addToRepeatedWrapperField(this, 10, opt_value, proto.onnx.NodeDeviceConfigurationProto, opt_index);
	};
	/**
	* Clears the list making it empty but non-null.
	* @return {!proto.onnx.NodeProto} returns this
	*/
	proto.onnx.NodeProto.prototype.clearDeviceConfigurationsList = function() {
		return this.setDeviceConfigurationsList([]);
	};
	/**
	* List of repeated fields within this message type.
	* @private {!Array<number>}
	* @const
	*/
	proto.onnx.IntIntListEntryProto.repeatedFields_ = [2];
	if (jspb.Message.GENERATE_TO_OBJECT) {
		/**
		* Creates an object representation of this proto.
		* Field names that are reserved in JavaScript and will be renamed to pb_name.
		...
		* @return {!Object}
		*/
		proto.onnx.IntIntListEntryProto.prototype.toObject = function(opt_includeInstance) {
			return proto.onnx.IntIntListEntryProto.toObject(opt_includeInstance, this);
		};
		/**
		* Static version of the {@see toObject} method.
		* @param {boolean|undefined} includeInstance Deprecated. Whether to include
		*     the JSPB instance for transitional soy proto support:
		*     http://goto/soy-param-migration
		* @param {!proto.onnx.IntIntListEntryProto} msg The msg instance to transform.
		* @return {!Object}
		* @suppress {unusedLocalVariables} f is only used for nested messages
		*/
		proto.onnx.IntIntListEntryProto.toObject = function(includeInstance, msg) {
			var f, obj = {
				key: (f = jspb.Message.getField(msg, 1)) == null ? void 0 : f,
	...
	* Deserializes binary data (in protobuf wire format).
	* @param {jspb.ByteSource} bytes The bytes to deserialize.
	* @return {!proto.onnx.IntIntListEntryProto}
	*/
	proto.onnx.IntIntListEntryProto.deserializeBinary = function(bytes) {
		var reader = new jspb.BinaryReader(bytes);
		var msg = new proto.onnx.IntIntListEntryProto();
		return proto.onnx.IntIntListEntryProto.deserializeBinaryFromReader(msg, reader);
	};
	/**
	* Deserializes binary data (in protobuf wire format) from the
	* given reader into the given message object.
	* @param {!proto.onnx.IntIntListEntryProto} msg The message object to deserialize into.
	* @param {!jspb.BinaryReader} reader The BinaryReader to use.
	* @return {!proto.onnx.IntIntListEntryProto}
	*/
	proto.onnx.IntIntListEntryProto.deserializeBinaryFromReader = function(msg, reader) {
		while (reader.nextField()) {
			if (reader.isEndGroup()) break;
			switch (reader.getFieldNumber()) {
				case 1:
	...
	* @return {!Uint8Array}
	*/
	proto.onnx.IntIntListEntryProto.prototype.serializeBinary = function() {
		var writer = new jspb.BinaryWriter();
		proto.onnx.IntIntListEntryProto.serializeBinaryToWriter(this, writer);
		return writer.getResultBuffer();
	};
	/**
	* Serializes the given message to binary data (in protobuf wire
	* format), writing to the given BinaryWriter.
	* @param {!proto.onnx.IntIntListEntryProto} message
	* @param {!jspb.BinaryWriter} writer
	* @suppress {unusedLocalVariables} f is only used for nested messages
	*/
	proto.onnx.IntIntListEntryProto.serializeBinaryToWriter = function(message, writer) {
		var f = void 0;
		f = jspb.Message.getField(message, 1);
		if (f != null) writer.writeInt64(1, f);
		f = message.getValueList();
		if (f.length > 0) writer.writeRepeatedInt64(2, f);
	};
	/**
	* optional int64 key = 1;
	* @return {number}
	*/
	proto.onnx.IntIntListEntryProto.prototype.getKey = function() {
		return jspb.Message.getFieldWithDefault(this, 1, 0);
	};
	/**
	* @param {number} value
	* @return {!proto.onnx.IntIntListEntryProto} returns this
	*/
	proto.onnx.IntIntListEntryProto.prototype.setKey = function(value) {
		return jspb.Message.setField(this, 1, value);
	};
	/**
	* Clears the field making it undefined.
	* @return {!proto.onnx.IntIntListEntryProto} returns this
	*/
	proto.onnx.IntIntListEntryProto.prototype.clearKey = function() {
		return jspb.Message.setField(this, 1, void 0);
	};
	/**
	* Returns whether this field is set.
	* @return {boolean}
	*/
	proto.onnx.IntIntListEntryProto.prototype.hasKey = function() {
		return jspb.Message.getField(this, 1) != null;
	};
	/**
	...
	* @return {!Array<number>}
	*/
	proto.onnx.IntIntListEntryProto.prototype.getValueList = function() {
		return jspb.Message.getRepeatedField(this, 2);
	};
	/**
	* @param {!Array<number>} value
	* @return {!proto.onnx.IntIntListEntryProto} returns this
	*/
	proto.onnx.IntIntListEntryProto.prototype.setValueList = function(value) {
		return jspb.Message.setField(this, 2, value || []);
	};
	/**
	* @param {number} value
	...
	* @return {!proto.onnx.IntIntListEntryProto} returns this
	*/
	proto.onnx.IntIntListEntryProto.prototype.addValue = function(value, opt_index) {
		return jspb.Message.addToRepeatedField(this, 2, value, opt_index);
	};
	/**
	* Clears the list making it empty but non-null.
	* @return {!proto.onnx.IntIntListEntryProto} returns this
	*/
	proto.onnx.IntIntListEntryProto.prototype.clearValueList = function() {
	...
	* @const
	*/
	proto.onnx.NodeDeviceConfigurationProto.repeatedFields_ = [2];
	if (jspb.Message.GENERATE_TO_OBJECT) {
		/**
		* Creates an object representation of this proto.
		* Field names that are reserved in JavaScript and will be renamed to pb_name.
		...
		* @return {!Object}
		*/
		proto.onnx.NodeDeviceConfigurationProto.prototype.toObject = function(opt_includeInstance) {
			return proto.onnx.NodeDeviceConfigurationProto.toObject(opt_includeInstance, this);
		};
		/**
		* Static version of the {@see toObject} method.
		* @param {boolean|undefined} includeInstance Deprecated. Whether to include
		*     the JSPB instance for transitional soy proto support:
		*     http://goto/soy-param-migration
		* @param {!proto.onnx.NodeDeviceConfigurationProto} msg The msg instance to transform.
		* @return {!Object}
		* @suppress {unusedLocalVariables} f is only used for nested messages
		*/
		proto.onnx.NodeDeviceConfigurationProto.toObject = function(includeInstance, msg) {
			var f, obj = {
				configurationId: (f = jspb.Message.getField(msg, 1)) == null ? void 0 : f,
				shardingSpecList: jspb.Message.toObjectList(msg.getShardingSpecList(), proto.onnx.ShardingSpecProto.toObject, includeInstance),
				pipelineStage: (f = jspb.Message.getField(msg, 3)) == null ? void 0 : f
			};
			if (includeInstance) obj.$jspbMessageInstance = msg;
			return obj;
		};
	...
	* @return {!proto.onnx.NodeDeviceConfigurationProto}
	*/
	proto.onnx.NodeDeviceConfigurationProto.deserializeBinary = function(bytes) {
		var reader = new jspb.BinaryReader(bytes);
		var msg = new proto.onnx.NodeDeviceConfigurationProto();
		return proto.onnx.NodeDeviceConfigurationProto.deserializeBinaryFromReader(msg, reader);
	};
	/**
	* Deserializes binary data (in protobuf wire format) from the
	* given reader into the given message object.
	* @param {!proto.onnx.NodeDeviceConfigurationProto} msg The message object to deserialize into.
	* @param {!jspb.BinaryReader} reader The BinaryReader to use.
	* @return {!proto.onnx.NodeDeviceConfigurationProto}
	*/
	proto.onnx.NodeDeviceConfigurationProto.deserializeBinaryFromReader = function(msg, reader) {
		while (reader.nextField()) {
			if (reader.isEndGroup()) break;
			switch (reader.getFieldNumber()) {
				case 1:
					...
					break;
				case 2:
					var value = new proto.onnx.ShardingSpecProto();
					reader.readMessage(value, proto.onnx.ShardingSpecProto.deserializeBinaryFromReader);
					msg.addShardingSpec(value);
					break;
				case 3:
					var value = reader.readInt32();
					msg.setPipelineStage(value);
					break;
				default:
					reader.skipField();
					break;
	...
	* @return {!Uint8Array}
	*/
	proto.onnx.NodeDeviceConfigurationProto.prototype.serializeBinary = function() {
		var writer = new jspb.BinaryWriter();
		proto.onnx.NodeDeviceConfigurationProto.serializeBinaryToWriter(this, writer);
		return writer.getResultBuffer();
	};
	/**
	* Serializes the given message to binary data (in protobuf wire
	* format), writing to the given BinaryWriter.
	* @param {!proto.onnx.NodeDeviceConfigurationProto} message
	* @param {!jspb.BinaryWriter} writer
	* @suppress {unusedLocalVariables} f is only used for nested messages
	*/
	proto.onnx.NodeDeviceConfigurationProto.serializeBinaryToWriter = function(message, writer) {
		var f = void 0;
		f = jspb.Message.getField(message, 1);
		if (f != null) writer.writeString(1, f);
		f = message.getShardingSpecList();
		if (f.length > 0) writer.writeRepeatedMessage(2, f, proto.onnx.ShardingSpecProto.serializeBinaryToWriter);
		f = jspb.Message.getField(message, 3);
		if (f != null) writer.writeInt32(3, f);
	};
	/**
	* optional string configuration_id = 1;
	* @return {string}
	*/
	proto.onnx.NodeDeviceConfigurationProto.prototype.getConfigurationId = function() {
		return jspb.Message.getFieldWithDefault(this, 1, "");
	};
	/**
	* @param {string} value
	* @return {!proto.onnx.NodeDeviceConfigurationProto} returns this
	*/
	proto.onnx.NodeDeviceConfigurationProto.prototype.setConfigurationId = function(value) {
		return jspb.Message.setField(this, 1, value);
	};
	/**
	* Clears the field making it undefined.
	* @return {!proto.onnx.NodeDeviceConfigurationProto} returns this
	*/
	proto.onnx.NodeDeviceConfigurationProto.prototype.clearConfigurationId = function() {
		return jspb.Message.setField(this, 1, void 0);
	};
	/**
	* Returns whether this field is set.
	* @return {boolean}
	*/
	proto.onnx.NodeDeviceConfigurationProto.prototype.hasConfigurationId = function() {
		return jspb.Message.getField(this, 1) != null;
	};
	/**
	* repeated ShardingSpecProto sharding_spec = 2;
	* @return {!Array<!proto.onnx.ShardingSpecProto>}
	*/
	proto.onnx.NodeDeviceConfigurationProto.prototype.getShardingSpecList = function() {
		return jspb.Message.getRepeatedWrapperField(this, proto.onnx.ShardingSpecProto, 2);
	};
	/**
	* @param {!Array<!proto.onnx.ShardingSpecProto>} value
	* @return {!proto.onnx.NodeDeviceConfigurationProto} returns this
	*/
	proto.onnx.NodeDeviceConfigurationProto.prototype.setShardingSpecList = function(value) {
		return jspb.Message.setRepeatedWrapperField(this, 2, value);
	};
	/**
	* @param {!proto.onnx.ShardingSpecProto=} opt_value
	* @param {number=} opt_index
	* @return {!proto.onnx.ShardingSpecProto}
	*/
	proto.onnx.NodeDeviceConfigurationProto.prototype.addShardingSpec = function(opt_value, opt_index) {
		return jspb.Message.addToRepeatedWrapperField(this, 2, opt_value, proto.onnx.ShardingSpecProto, opt_index);
	};
	/**
	* Clears the list making it empty but non-null.
	* @return {!proto.onnx.NodeDeviceConfigurationProto} returns this
	*/
	proto.onnx.NodeDeviceConfigurationProto.prototype.clearShardingSpecList = function() {
		return this.setShardingSpecList([]);
	};
	/**
	* optional int32 pipeline_stage = 3;
	* @return {number}
	*/
	proto.onnx.NodeDeviceConfigurationProto.prototype.getPipelineStage = function() {
		return jspb.Message.getFieldWithDefault(this, 3, 0);
	};
	/**
	* @param {number} value
	* @return {!proto.onnx.NodeDeviceConfigurationProto} returns this
	*/
	proto.onnx.NodeDeviceConfigurationProto.prototype.setPipelineStage = function(value) {
		return jspb.Message.setField(this, 3, value);
	};
	/**
	* Clears the field making it undefined.
	* @return {!proto.onnx.NodeDeviceConfigurationProto} returns this
	*/
	proto.onnx.NodeDeviceConfigurationProto.prototype.clearPipelineStage = function() {
		return jspb.Message.setField(this, 3, void 0);
	};
	/**
	* Returns whether this field is set.
	* @return {boolean}
	*/
	proto.onnx.NodeDeviceConfigurationProto.prototype.hasPipelineStage = function() {
		return jspb.Message.getField(this, 3) != null;
	};
	/**
	* List of repeated fields within this message type.
	...
	* @const
	*/
	proto.onnx.ShardingSpecProto.repeatedFields_ = [
		2,
		3,
		4
	];
	if (jspb.Message.GENERATE_TO_OBJECT) {
		...
		* @return {!Object}
		*/
		proto.onnx.ShardingSpecProto.prototype.toObject = function(opt_includeInstance) {
			return proto.onnx.ShardingSpecProto.toObject(opt_includeInstance, this);
		};
		/**
		* Static version of the {@see toObject} method.
		* @param {boolean|undefined} includeInstance Deprecated. Whether to include
		*     the JSPB instance for transitional soy proto support:
		*     http://goto/soy-param-migration
		* @param {!proto.onnx.ShardingSpecProto} msg The msg instance to transform.
		* @return {!Object}
		* @suppress {unusedLocalVariables} f is only used for nested messages
		*/
		proto.onnx.ShardingSpecProto.toObject = function(includeInstance, msg) {
			var f, obj = {
				tensorName: (f = jspb.Message.getField(msg, 1)) == null ? void 0 : f,
				deviceList: (f = jspb.Message.getRepeatedField(msg, 2)) == null ? void 0 : f,
				indexToDeviceGroupMapList: jspb.Message.toObjectList(msg.getIndexToDeviceGroupMapList(), proto.onnx.IntIntListEntryProto.toObject, includeInstance),
				shardedDimList: jspb.Message.toObjectList(msg.getShardedDimList(), proto.onnx.ShardedDimProto.toObject, includeInstance)
			};
			if (includeInstance) obj.$jspbMessageInstance = msg;
			return obj;
		};
	...
	* @return {!proto.onnx.ShardingSpecProto}
	*/
	proto.onnx.ShardingSpecProto.deserializeBinary = function(bytes) {
		var reader = new jspb.BinaryReader(bytes);
		var msg = new proto.onnx.ShardingSpecProto();
		return proto.onnx.ShardingSpecProto.deserializeBinaryFromReader(msg, reader);
	};
	/**
	* Deserializes binary data (in protobuf wire format) from the
	* given reader into the given message object.
	* @param {!proto.onnx.ShardingSpecProto} msg The message object to deserialize into.
	* @param {!jspb.BinaryReader} reader The BinaryReader to use.
	* @return {!proto.onnx.ShardingSpecProto}
	*/
	proto.onnx.ShardingSpecProto.deserializeBinaryFromReader = function(msg, reader) {
		while (reader.nextField()) {
			if (reader.isEndGroup()) break;
			switch (reader.getFieldNumber()) {
				case 1:
				...
				case 2:
					var values = reader.isDelimited() ? reader.readPackedInt64() : [reader.readInt64()];
					for (var i = 0; i < values.length; i++) msg.addDevice(values[i]);
					break;
				case 3:
					var value = new proto.onnx.IntIntListEntryProto();
					reader.readMessage(value, proto.onnx.IntIntListEntryProto.deserializeBinaryFromReader);
					msg.addIndexToDeviceGroupMap(value);
					break;
				case 4:
					var value = new proto.onnx.ShardedDimProto();
					reader.readMessage(value, proto.onnx.ShardedDimProto.deserializeBinaryFromReader);
					msg.addShardedDim(value);
					break;
				default:
					reader.skipField();
					break;
	...
	* @return {!Uint8Array}
	*/
	proto.onnx.ShardingSpecProto.prototype.serializeBinary = function() {
		var writer = new jspb.BinaryWriter();
		proto.onnx.ShardingSpecProto.serializeBinaryToWriter(this, writer);
		return writer.getResultBuffer();
	};
	/**
	* Serializes the given message to binary data (in protobuf wire
	* format), writing to the given BinaryWriter.
	* @param {!proto.onnx.ShardingSpecProto} message
	* @param {!jspb.BinaryWriter} writer
	* @suppress {unusedLocalVariables} f is only used for nested messages
	*/
	proto.onnx.ShardingSpecProto.serializeBinaryToWriter = function(message, writer) {
		var f = void 0;
		f = jspb.Message.getField(message, 1);
		if (f != null) writer.writeString(1, f);
		f = message.getDeviceList();
		if (f.length > 0) writer.writeRepeatedInt64(2, f);
		f = message.getIndexToDeviceGroupMapList();
		if (f.length > 0) writer.writeRepeatedMessage(3, f, proto.onnx.IntIntListEntryProto.serializeBinaryToWriter);
		f = message.getShardedDimList();
		if (f.length > 0) writer.writeRepeatedMessage(4, f, proto.onnx.ShardedDimProto.serializeBinaryToWriter);
	};
	/**
	* optional string tensor_name = 1;
	* @return {string}
	*/
	proto.onnx.ShardingSpecProto.prototype.getTensorName = function() {
		return jspb.Message.getFieldWithDefault(this, 1, "");
	};
	/**
	* @param {string} value
	* @return {!proto.onnx.ShardingSpecProto} returns this
	*/
	proto.onnx.ShardingSpecProto.prototype.setTensorName = function(value) {
		return jspb.Message.setField(this, 1, value);
	};
	/**
	* Clears the field making it undefined.
	* @return {!proto.onnx.ShardingSpecProto} returns this
	*/
	proto.onnx.ShardingSpecProto.prototype.clearTensorName = function() {
		return jspb.Message.setField(this, 1, void 0);
	};
	/**
	* Returns whether this field is set.
	* @return {boolean}
	*/
	proto.onnx.ShardingSpecProto.prototype.hasTensorName = function() {
		return jspb.Message.getField(this, 1) != null;
	};
	/**
	...
	* @return {!Array<number>}
	*/
	proto.onnx.ShardingSpecProto.prototype.getDeviceList = function() {
		return jspb.Message.getRepeatedField(this, 2);
	};
	/**
	* @param {!Array<number>} value
	* @return {!proto.onnx.ShardingSpecProto} returns this
	*/
	proto.onnx.ShardingSpecProto.prototype.setDeviceList = function(value) {
		return jspb.Message.setField(this, 2, value || []);
	};
	/**
	* @param {number} value
	...
	* @return {!proto.onnx.ShardingSpecProto} returns this
	*/
	proto.onnx.ShardingSpecProto.prototype.addDevice = function(value, opt_index) {
		return jspb.Message.addToRepeatedField(this, 2, value, opt_index);
	};
	/**
	* Clears the list making it empty but non-null.
	* @return {!proto.onnx.ShardingSpecProto} returns this
	*/
	proto.onnx.ShardingSpecProto.prototype.clearDeviceList = function() {
		return this.setDeviceList([]);
	};
	/**
	* repeated IntIntListEntryProto index_to_device_group_map = 3;
	* @return {!Array<!proto.onnx.IntIntListEntryProto>}
	*/
	proto.onnx.ShardingSpecProto.prototype.getIndexToDeviceGroupMapList = function() {
		return jspb.Message.getRepeatedWrapperField(this, proto.onnx.IntIntListEntryProto, 3);
	};
	/**
	* @param {!Array<!proto.onnx.IntIntListEntryProto>} value
	* @return {!proto.onnx.ShardingSpecProto} returns this
	*/
	proto.onnx.ShardingSpecProto.prototype.setIndexToDeviceGroupMapList = function(value) {
		return jspb.Message.setRepeatedWrapperField(this, 3, value);
	};
	/**
	* @param {!proto.onnx.IntIntListEntryProto=} opt_value
	* @param {number=} opt_index
	* @return {!proto.onnx.IntIntListEntryProto}
	*/
	proto.onnx.ShardingSpecProto.prototype.addIndexToDeviceGroupMap = function(opt_value, opt_index) {
		return jspb.Message.addToRepeatedWrapperField(this, 3, opt_value, proto.onnx.IntIntListEntryProto, opt_index);
	};
	/**
	* Clears the list making it empty but non-null.
	* @return {!proto.onnx.ShardingSpecProto} returns this
	*/
	proto.onnx.ShardingSpecProto.prototype.clearIndexToDeviceGroupMapList = function() {
		return this.setIndexToDeviceGroupMapList([]);
	};
	/**
	* repeated ShardedDimProto sharded_dim = 4;
	* @return {!Array<!proto.onnx.ShardedDimProto>}
	*/
	proto.onnx.ShardingSpecProto.prototype.getShardedDimList = function() {
		return jspb.Message.getRepeatedWrapperField(this, proto.onnx.ShardedDimProto, 4);
	};
	/**
	* @param {!Array<!proto.onnx.ShardedDimProto>} value
	* @return {!proto.onnx.ShardingSpecProto} returns this
	*/
	proto.onnx.ShardingSpecProto.prototype.setShardedDimList = function(value) {
		return jspb.Message.setRepeatedWrapperField(this, 4, value);
	};
	/**
	* @param {!proto.onnx.ShardedDimProto=} opt_value
	* @param {number=} opt_index
	* @return {!proto.onnx.ShardedDimProto}
	*/
	proto.onnx.ShardingSpecProto.prototype.addShardedDim = function(opt_value, opt_index) {
		return jspb.Message.addToRepeatedWrapperField(this, 4, opt_value, proto.onnx.ShardedDimProto, opt_index);
	};
	/**
	* Clears the list making it empty but non-null.
	* @return {!proto.onnx.ShardingSpecProto} returns this
	*/
	proto.onnx.ShardingSpecProto.prototype.clearShardedDimList = function() {
		return this.setShardedDimList([]);
	};
	/**
	* List of repeated fields within this message type.
	* @private {!Array<number>}
	* @const
	*/
	proto.onnx.ShardedDimProto.repeatedFields_ = [2];
	if (jspb.Message.GENERATE_TO_OBJECT) {
		/**
		* Creates an object representation of this proto.
		* Field names that are reserved in JavaScript and will be renamed to pb_name.
		...
		* @return {!Object}
		*/
		proto.onnx.ShardedDimProto.prototype.toObject = function(opt_includeInstance) {
			return proto.onnx.ShardedDimProto.toObject(opt_includeInstance, this);
		};
		/**
		* Static version of the {@see toObject} method.
		* @param {boolean|undefined} includeInstance Deprecated. Whether to include
		*     the JSPB instance for transitional soy proto support:
		*     http://goto/soy-param-migration
		* @param {!proto.onnx.ShardedDimProto} msg The msg instance to transform.
		* @return {!Object}
		* @suppress {unusedLocalVariables} f is only used for nested messages
		*/
		proto.onnx.ShardedDimProto.toObject = function(includeInstance, msg) {
			var f, obj = {
				axis: (f = jspb.Message.getField(msg, 1)) == null ? void 0 : f,
				simpleShardingList: jspb.Message.toObjectList(msg.getSimpleShardingList(), proto.onnx.SimpleShardedDimProto.toObject, includeInstance)
			};
			if (includeInstance) obj.$jspbMessageInstance = msg;
			return obj;
		};
	...
	* @return {!proto.onnx.ShardedDimProto}
	*/
	proto.onnx.ShardedDimProto.deserializeBinary = function(bytes) {
		var reader = new jspb.BinaryReader(bytes);
		var msg = new proto.onnx.ShardedDimProto();
		return proto.onnx.ShardedDimProto.deserializeBinaryFromReader(msg, reader);
	};
	/**
	* Deserializes binary data (in protobuf wire format) from the
	* given reader into the given message object.
	* @param {!proto.onnx.ShardedDimProto} msg The message object to deserialize into.
	* @param {!jspb.BinaryReader} reader The BinaryReader to use.
	* @return {!proto.onnx.ShardedDimProto}
	*/
	proto.onnx.ShardedDimProto.deserializeBinaryFromReader = function(msg, reader) {
		while (reader.nextField()) {
			if (reader.isEndGroup()) break;
			switch (reader.getFieldNumber()) {
				case 1:
					...
					break;
				case 2:
					var value = new proto.onnx.SimpleShardedDimProto();
					reader.readMessage(value, proto.onnx.SimpleShardedDimProto.deserializeBinaryFromReader);
					msg.addSimpleSharding(value);
					break;
				default:
					reader.skipField();
					break;
	...
	* @return {!Uint8Array}
	*/
	proto.onnx.ShardedDimProto.prototype.serializeBinary = function() {
		var writer = new jspb.BinaryWriter();
		proto.onnx.ShardedDimProto.serializeBinaryToWriter(this, writer);
		return writer.getResultBuffer();
	};
	/**
	* Serializes the given message to binary data (in protobuf wire
	* format), writing to the given BinaryWriter.
	* @param {!proto.onnx.ShardedDimProto} message
	* @param {!jspb.BinaryWriter} writer
	* @suppress {unusedLocalVariables} f is only used for nested messages
	*/
	proto.onnx.ShardedDimProto.serializeBinaryToWriter = function(message, writer) {
		var f = void 0;
		f = jspb.Message.getField(message, 1);
		if (f != null) writer.writeInt64(1, f);
		f = message.getSimpleShardingList();
		if (f.length > 0) writer.writeRepeatedMessage(2, f, proto.onnx.SimpleShardedDimProto.serializeBinaryToWriter);
	};
	/**
	* optional int64 axis = 1;
	* @return {number}
	*/
	proto.onnx.ShardedDimProto.prototype.getAxis = function() {
		return jspb.Message.getFieldWithDefault(this, 1, 0);
	};
	/**
	* @param {number} value
	* @return {!proto.onnx.ShardedDimProto} returns this
	*/
	proto.onnx.ShardedDimProto.prototype.setAxis = function(value) {
		return jspb.Message.setField(this, 1, value);
	};
	/**
	* Clears the field making it undefined.
	* @return {!proto.onnx.ShardedDimProto} returns this
	*/
	proto.onnx.ShardedDimProto.prototype.clearAxis = function() {
		return jspb.Message.setField(this, 1, void 0);
	};
	/**
	* Returns whether this field is set.
	* @return {boolean}
	*/
	proto.onnx.ShardedDimProto.prototype.hasAxis = function() {
		return jspb.Message.getField(this, 1) != null;
	};
	/**
	* repeated SimpleShardedDimProto simple_sharding = 2;
	* @return {!Array<!proto.onnx.SimpleShardedDimProto>}
	*/
	proto.onnx.ShardedDimProto.prototype.getSimpleShardingList = function() {
		return jspb.Message.getRepeatedWrapperField(this, proto.onnx.SimpleShardedDimProto, 2);
	};
	/**
	* @param {!Array<!proto.onnx.SimpleShardedDimProto>} value
	* @return {!proto.onnx.ShardedDimProto} returns this
	*/
	proto.onnx.ShardedDimProto.prototype.setSimpleShardingList = function(value) {
		return jspb.Message.setRepeatedWrapperField(this, 2, value);
	};
	/**
	* @param {!proto.onnx.SimpleShardedDimProto=} opt_value
	* @param {number=} opt_index
	* @return {!proto.onnx.SimpleShardedDimProto}
	*/
	proto.onnx.ShardedDimProto.prototype.addSimpleSharding = function(opt_value, opt_index) {
		return jspb.Message.addToRepeatedWrapperField(this, 2, opt_value, proto.onnx.SimpleShardedDimProto, opt_index);
	};
	/**
	* Clears the list making it empty but non-null.
	* @return {!proto.onnx.ShardedDimProto} returns this
	*/
	proto.onnx.ShardedDimProto.prototype.clearSimpleShardingList = function() {
		return this.setSimpleShardingList([]);
	};
	/**
	...
	* @const
	*/
	proto.onnx.SimpleShardedDimProto.oneofGroups_ = [[1, 2]];
	/**
	* @enum {number}
	*/
	proto.onnx.SimpleShardedDimProto.DimCase = {
		DIM_NOT_SET: 0,
		DIM_VALUE: 1,
		DIM_PARAM: 2
	};
	/**
	* @return {proto.onnx.SimpleShardedDimProto.DimCase}
	*/
	proto.onnx.SimpleShardedDimProto.prototype.getDimCase = function() {
		return jspb.Message.computeOneofCase(this, proto.onnx.SimpleShardedDimProto.oneofGroups_[0]);
	};
	if (jspb.Message.GENERATE_TO_OBJECT) {
		/**
		* Creates an object representation of this proto.
		...
		* @return {!Object}
		*/
		proto.onnx.SimpleShardedDimProto.prototype.toObject = function(opt_includeInstance) {
			return proto.onnx.SimpleShardedDimProto.toObject(opt_includeInstance, this);
		};
		/**
		* Static version of the {@see toObject} method.
		* @param {boolean|undefined} includeInstance Deprecated. Whether to include
		*     the JSPB instance for transitional soy proto support:
		*     http://goto/soy-param-migration
		* @param {!proto.onnx.SimpleShardedDimProto} msg The msg instance to transform.
		* @return {!Object}
		* @suppress {unusedLocalVariables} f is only used for nested messages
		*/
		proto.onnx.SimpleShardedDimProto.toObject = function(includeInstance, msg) {
			var f, obj = {
				dimValue: (f = jspb.Message.getField(msg, 1)) == null ? void 0 : f,
				dimParam: (f = jspb.Message.getField(msg, 2)) == null ? void 0 : f,
				numShards: (f = jspb.Message.getField(msg, 3)) == null ? void 0 : f
			};
			if (includeInstance) obj.$jspbMessageInstance = msg;
			return obj;
		};
	...
	* @return {!proto.onnx.SimpleShardedDimProto}
	*/
	proto.onnx.SimpleShardedDimProto.deserializeBinary = function(bytes) {
		var reader = new jspb.BinaryReader(bytes);
		var msg = new proto.onnx.SimpleShardedDimProto();
		return proto.onnx.SimpleShardedDimProto.deserializeBinaryFromReader(msg, reader);
	};
	/**
	* Deserializes binary data (in protobuf wire format) from the
	* given reader into the given message object.
	* @param {!proto.onnx.SimpleShardedDimProto} msg The message object to deserialize into.
	* @param {!jspb.BinaryReader} reader The BinaryReader to use.
	* @return {!proto.onnx.SimpleShardedDimProto}
	*/
	proto.onnx.SimpleShardedDimProto.deserializeBinaryFromReader = function(msg, reader) {
		while (reader.nextField()) {
			if (reader.isEndGroup()) break;
			switch (reader.getFieldNumber()) {
				case 1:
	...
	* @return {!Uint8Array}
	*/
	proto.onnx.SimpleShardedDimProto.prototype.serializeBinary = function() {
		var writer = new jspb.BinaryWriter();
		proto.onnx.SimpleShardedDimProto.serializeBinaryToWriter(this, writer);
		return writer.getResultBuffer();
	};
	/**
	* Serializes the given message to binary data (in protobuf wire
	* format), writing to the given BinaryWriter.
	* @param {!proto.onnx.SimpleShardedDimProto} message
	* @param {!jspb.BinaryWriter} writer
	* @suppress {unusedLocalVariables} f is only used for nested messages
	*/
	proto.onnx.SimpleShardedDimProto.serializeBinaryToWriter = function(message, writer) {
		var f = void 0;
		f = jspb.Message.getField(message, 1);
		if (f != null) writer.writeInt64(1, f);
		f = jspb.Message.getField(message, 2);
		if (f != null) writer.writeString(2, f);
		f = jspb.Message.getField(message, 3);
		if (f != null) writer.writeInt64(3, f);
	};
	/**
	...
	* @return {number}
	*/
	proto.onnx.SimpleShardedDimProto.prototype.getDimValue = function() {
		return jspb.Message.getFieldWithDefault(this, 1, 0);
	};
	/**
	* @param {number} value
	* @return {!proto.onnx.SimpleShardedDimProto} returns this
	*/
	proto.onnx.SimpleShardedDimProto.prototype.setDimValue = function(value) {
		return jspb.Message.setOneofField(this, 1, proto.onnx.SimpleShardedDimProto.oneofGroups_[0], value);
	};
	/**
	* Clears the field making it undefined.
	* @return {!proto.onnx.SimpleShardedDimProto} returns this
	*/
	proto.onnx.SimpleShardedDimProto.prototype.clearDimValue = function() {
		return jspb.Message.setOneofField(this, 1, proto.onnx.SimpleShardedDimProto.oneofGroups_[0], void 0);
	};
	/**
	* Returns whether this field is set.
	* @return {boolean}
	*/
	proto.onnx.SimpleShardedDimProto.prototype.hasDimValue = function() {
		return jspb.Message.getField(this, 1) != null;
	};
	/**
	...
	* @return {string}
	*/
	proto.onnx.SimpleShardedDimProto.prototype.getDimParam = function() {
	...
	* @return {!proto.onnx.SimpleShardedDimProto} returns this
	*/
	proto.onnx.SimpleShardedDimProto.prototype.setDimParam = function(value) {
		return jspb.Message.setOneofField(this, 2, proto.onnx.SimpleShardedDimProto.oneofGroups_[0], value);
	};
	/**
	* Clears the field making it undefined.
	* @return {!proto.onnx.SimpleShardedDimProto} returns this
	*/
	proto.onnx.SimpleShardedDimProto.prototype.clearDimParam = function() {
		return jspb.Message.setOneofField(this, 2, proto.onnx.SimpleShardedDimProto.oneofGroups_[0], void 0);
	};
	/**
	* Returns whether this field is set.
	* @return {boolean}
	*/
	proto.onnx.SimpleShardedDimProto.prototype.hasDimParam = function() {
		return jspb.Message.getField(this, 2) != null;
	};
	/**
	...
	* @return {number}
	*/
	proto.onnx.SimpleShardedDimProto.prototype.getNumShards = function() {
		return jspb.Message.getFieldWithDefault(this, 3, 0);
	};
	/**
	* @param {number} value
	* @return {!proto.onnx.SimpleShardedDimProto} returns this
	*/
	proto.onnx.SimpleShardedDimProto.prototype.setNumShards = function(value) {
		return jspb.Message.setField(this, 3, value);
	};
	/**
	* Clears the field making it undefined.
	* @return {!proto.onnx.SimpleShardedDimProto} returns this
	*/
	proto.onnx.SimpleShardedDimProto.prototype.clearNumShards = function() {
		return jspb.Message.setField(this, 3, void 0);
	};
	/**
	* Returns whether this field is set.
	* @return {boolean}
	*/
	proto.onnx.SimpleShardedDimProto.prototype.hasNumShards = function() {
		return jspb.Message.getField(this, 3) != null;
	};
	/**
	* List of repeated fields within this message type.
		...
		*/
		proto.onnx.TrainingInfoProto.toObject = function(includeInstance, msg) {
			var f, obj = {
				...
				initializationBindingList: jspb.Message.toObjectList(msg.getInitializationBindingList(), proto.onnx.StringStringEntryProto.toObject, includeInstance),
				updateBindingList: jspb.Message.toObjectList(msg.getUpdateBindingList(), proto.onnx.StringStringEntryProto.toObject, includeInstance)
			};
			if (includeInstance) obj.$jspbMessageInstance = msg;
			return obj;
		};
	...
	*/
	proto.onnx.TrainingInfoProto.serializeBinaryToWriter = function(message, writer) {
		...
		if (f != null) writer.writeMessage(1, f, proto.onnx.GraphProto.serializeBinaryToWriter);
		f = message.getAlgorithm();
		if (f != null) writer.writeMessage(2, f, proto.onnx.GraphProto.serializeBinaryToWriter);
		f = message.getInitializationBindingList();
		if (f.length > 0) writer.writeRepeatedMessage(3, f, proto.onnx.StringStringEntryProto.serializeBinaryToWriter);
	...
	*/
	proto.onnx.TrainingInfoProto.prototype.getInitialization = function() {
		return jspb.Message.getWrapperField(this, proto.onnx.GraphProto, 1);
	};
	/**
	* @param {?proto.onnx.GraphProto|undefined} value
	...
	*/
	proto.onnx.TrainingInfoProto.prototype.clearInitialization = function() {
		return this.setInitialization(void 0);
	};
	/**
	* Returns whether this field is set.
	* @return {boolean}
	...
	*/
	proto.onnx.TrainingInfoProto.prototype.getAlgorithm = function() {
		return jspb.Message.getWrapperField(this, proto.onnx.GraphProto, 2);
	};
	/**
	* @param {?proto.onnx.GraphProto|undefined} value
	* @return {!proto.onnx.TrainingInfoProto} returns this
	...
	*/
	proto.onnx.TrainingInfoProto.prototype.clearAlgorithm = function() {
		return this.setAlgorithm(void 0);
	};
	/**
	* Returns whether this field is set.
	* @return {boolean}
	...
	*/
	proto.onnx.TrainingInfoProto.prototype.getInitializationBindingList = function() {
		return jspb.Message.getRepeatedWrapperField(this, proto.onnx.StringStringEntryProto, 3);
	};
	/**
	* @param {!Array<!proto.onnx.StringStringEntryProto>} value
	* @return {!proto.onnx.TrainingInfoProto} returns this
	...
	* @const
	*/
	proto.onnx.ModelProto.repeatedFields_ = [
		8,
		14,
		20,
		25,
	...
	if (jspb.Message.GENERATE_TO_OBJECT) {
		...
		*/
		proto.onnx.ModelProto.toObject = function(includeInstance, msg) {
			var f, obj = {
				irVersion: (f = jspb.Message.getField(msg, 1)) == null ? void 0 : f,
				opsetImportList: jspb.Message.toObjectList(msg.getOpsetImportList(), proto.onnx.OperatorSetIdProto.toObject, includeInstance),
				producerName: (f = jspb.Message.getField(msg, 2)) == null ? void 0 : f,
				producerVersion: (f = jspb.Message.getField(msg, 3)) == null ? void 0 : f,
				domain: (f = jspb.Message.getField(msg, 4)) == null ? void 0 : f,
				modelVersion: (f = jspb.Message.getField(msg, 5)) == null ? void 0 : f,
				docString: (f = jspb.Message.getField(msg, 6)) == null ? void 0 : f,
				graph: (f = msg.getGraph()) && proto.onnx.GraphProto.toObject(includeInstance, f),
				metadataPropsList: jspb.Message.toObjectList(msg.getMetadataPropsList(), proto.onnx.StringStringEntryProto.toObject, includeInstance),
				trainingInfoList: jspb.Message.toObjectList(msg.getTrainingInfoList(), proto.onnx.TrainingInfoProto.toObject, includeInstance),
				functionsList: jspb.Message.toObjectList(msg.getFunctionsList(), proto.onnx.FunctionProto.toObject, includeInstance),
				configurationList: jspb.Message.toObjectList(msg.getConfigurationList(), proto.onnx.DeviceConfigurationProto.toObject, includeInstance)
			};
			if (includeInstance) obj.$jspbMessageInstance = msg;
			return obj;
		};
		...
		while (reader.nextField()) {
			...
			switch (reader.getFieldNumber()) {
				...
				case 25:
					...
					break;
				case 26:
					var value = new proto.onnx.DeviceConfigurationProto();
					reader.readMessage(value, proto.onnx.DeviceConfigurationProto.deserializeBinaryFromReader);
	...
	*/
	proto.onnx.ModelProto.serializeBinaryToWriter = function(message, writer) {
		...
		if (f.length > 0) writer.writeRepeatedMessage(8, f, proto.onnx.OperatorSetIdProto.serializeBinaryToWriter);
		f = jspb.Message.getField(message, 2);
		if (f != null) writer.writeString(2, f);
		f = jspb.Message.getField(message, 3);
		if (f != null) writer.writeString(3, f);
		...
		if (f != null) writer.writeInt64(5, f);
		f = jspb.Message.getField(message, 6);
		if (f != null) writer.writeString(6, f);
		f = message.getGraph();
		if (f != null) writer.writeMessage(7, f, proto.onnx.GraphProto.serializeBinaryToWriter);
		f = message.getMetadataPropsList();
		if (f.length > 0) writer.writeRepeatedMessage(14, f, proto.onnx.StringStringEntryProto.serializeBinaryToWriter);
		f = message.getTrainingInfoList();
		if (f.length > 0) writer.writeRepeatedMessage(20, f, proto.onnx.TrainingInfoProto.serializeBinaryToWriter);
		f = message.getFunctionsList();
		if (f.length > 0) writer.writeRepeatedMessage(25, f, proto.onnx.FunctionProto.serializeBinaryToWriter);
		f = message.getConfigurationList();
		if (f.length > 0) writer.writeRepeatedMessage(26, f, proto.onnx.DeviceConfigurationProto.serializeBinaryToWriter);
	};
	/**
	...
	*/
	proto.onnx.ModelProto.prototype.getOpsetImportList = function() {
		return jspb.Message.getRepeatedWrapperField(this, proto.onnx.OperatorSetIdProto, 8);
	};
	/**
	...
	*/
	proto.onnx.ModelProto.prototype.getGraph = function() {
		return jspb.Message.getWrapperField(this, proto.onnx.GraphProto, 7);
	};
	/**
	* @param {?proto.onnx.GraphProto|undefined} value
	* @return {!proto.onnx.ModelProto} returns this
	...
	*/
	proto.onnx.ModelProto.prototype.getMetadataPropsList = function() {
		return jspb.Message.getRepeatedWrapperField(this, proto.onnx.StringStringEntryProto, 14);
	};
	/**
	* @param {!Array<!proto.onnx.StringStringEntryProto>} value
	* @return {!proto.onnx.ModelProto} returns this
	...
	*/
	proto.onnx.ModelProto.prototype.getTrainingInfoList = function() {
		return jspb.Message.getRepeatedWrapperField(this, proto.onnx.TrainingInfoProto, 20);
	};
	/**
	...
	*/
	proto.onnx.ModelProto.prototype.getFunctionsList = function() {
		return jspb.Message.getRepeatedWrapperField(this, proto.onnx.FunctionProto, 25);
	};
	/**
	...
	* @return {!Array<!proto.onnx.DeviceConfigurationProto>}
	*/
	proto.onnx.ModelProto.prototype.getConfigurationList = function() {
		return jspb.Message.getRepeatedWrapperField(this, proto.onnx.DeviceConfigurationProto, 26);
	};
	/**
	* @param {!Array<!proto.onnx.DeviceConfigurationProto>} value
	* @return {!proto.onnx.ModelProto} returns this
	*/
	proto.onnx.ModelProto.prototype.setConfigurationList = function(value) {
		return jspb.Message.setRepeatedWrapperField(this, 26, value);
	};
	/**
	* @param {!proto.onnx.DeviceConfigurationProto=} opt_value
	* @param {number=} opt_index
	* @return {!proto.onnx.DeviceConfigurationProto}
	*/
	proto.onnx.ModelProto.prototype.addConfiguration = function(opt_value, opt_index) {
		return jspb.Message.addToRepeatedWrapperField(this, 26, opt_value, proto.onnx.DeviceConfigurationProto, opt_index);
	};
	/**
	* Clears the list making it empty but non-null.
	* @return {!proto.onnx.ModelProto} returns this
	*/
	proto.onnx.ModelProto.prototype.clearConfigurationList = function() {
		return this.setConfigurationList([]);
	};
	/**
	* List of repeated fields within this message type.
	* @private {!Array<number>}
	* @const
	*/
	proto.onnx.DeviceConfigurationProto.repeatedFields_ = [3];
	if (jspb.Message.GENERATE_TO_OBJECT) {
		/**
		* Creates an object representation of this proto.
		* Field names that are reserved in JavaScript and will be renamed to pb_name.
		...
		* @return {!Object}
		*/
		proto.onnx.DeviceConfigurationProto.prototype.toObject = function(opt_includeInstance) {
			return proto.onnx.DeviceConfigurationProto.toObject(opt_includeInstance, this);
		};
		/**
		* Static version of the {@see toObject} method.
		* @param {boolean|undefined} includeInstance Deprecated. Whether to include
		*     the JSPB instance for transitional soy proto support:
		*     http://goto/soy-param-migration
		* @param {!proto.onnx.DeviceConfigurationProto} msg The msg instance to transform.
		* @return {!Object}
		* @suppress {unusedLocalVariables} f is only used for nested messages
		*/
		proto.onnx.DeviceConfigurationProto.toObject = function(includeInstance, msg) {
			var f, obj = {
				name: (f = jspb.Message.getField(msg, 1)) == null ? void 0 : f,
				numDevices: (f = jspb.Message.getField(msg, 2)) == null ? void 0 : f,
				deviceList: (f = jspb.Message.getRepeatedField(msg, 3)) == null ? void 0 : f
			};
			if (includeInstance) obj.$jspbMessageInstance = msg;
			return obj;
		};
	...
	* @return {!proto.onnx.DeviceConfigurationProto}
	*/
	proto.onnx.DeviceConfigurationProto.deserializeBinary = function(bytes) {
		var reader = new jspb.BinaryReader(bytes);
		var msg = new proto.onnx.DeviceConfigurationProto();
		return proto.onnx.DeviceConfigurationProto.deserializeBinaryFromReader(msg, reader);
	};
	/**
	* Deserializes binary data (in protobuf wire format) from the
	* given reader into the given message object.
	* @param {!proto.onnx.DeviceConfigurationProto} msg The message object to deserialize into.
	* @param {!jspb.BinaryReader} reader The BinaryReader to use.
	* @return {!proto.onnx.DeviceConfigurationProto}
	*/
	proto.onnx.DeviceConfigurationProto.deserializeBinaryFromReader = function(msg, reader) {
		while (reader.nextField()) {
			if (reader.isEndGroup()) break;
			switch (reader.getFieldNumber()) {
				case 1:
	...
	* @return {!Uint8Array}
	*/
	proto.onnx.DeviceConfigurationProto.prototype.serializeBinary = function() {
		var writer = new jspb.BinaryWriter();
		proto.onnx.DeviceConfigurationProto.serializeBinaryToWriter(this, writer);
		return writer.getResultBuffer();
	};
	/**
	* Serializes the given message to binary data (in protobuf wire
	* format), writing to the given BinaryWriter.
	* @param {!proto.onnx.DeviceConfigurationProto} message
	* @param {!jspb.BinaryWriter} writer
	* @suppress {unusedLocalVariables} f is only used for nested messages
	*/
	proto.onnx.DeviceConfigurationProto.serializeBinaryToWriter = function(message, writer) {
		var f = void 0;
		f = jspb.Message.getField(message, 1);
		if (f != null) writer.writeString(1, f);
		f = jspb.Message.getField(message, 2);
		if (f != null) writer.writeInt32(2, f);
		f = message.getDeviceList();
	...
	* @return {string}
	*/
	proto.onnx.DeviceConfigurationProto.prototype.getName = function() {
		return jspb.Message.getFieldWithDefault(this, 1, "");
	};
	/**
	* @param {string} value
	* @return {!proto.onnx.DeviceConfigurationProto} returns this
	*/
	proto.onnx.DeviceConfigurationProto.prototype.setName = function(value) {
		return jspb.Message.setField(this, 1, value);
	};
	/**
	* Clears the field making it undefined.
	* @return {!proto.onnx.DeviceConfigurationProto} returns this
	*/
	proto.onnx.DeviceConfigurationProto.prototype.clearName = function() {
		return jspb.Message.setField(this, 1, void 0);
	};
	/**
	* Returns whether this field is set.
	* @return {boolean}
	*/
	proto.onnx.DeviceConfigurationProto.prototype.hasName = function() {
		return jspb.Message.getField(this, 1) != null;
	};
	/**
	...
	* @return {number}
	*/
	proto.onnx.DeviceConfigurationProto.prototype.getNumDevices = function() {
	...
	* @return {!proto.onnx.DeviceConfigurationProto} returns this
	*/
	proto.onnx.DeviceConfigurationProto.prototype.setNumDevices = function(value) {
		return jspb.Message.setField(this, 2, value);
	};
	/**
	* Clears the field making it undefined.
	* @return {!proto.onnx.DeviceConfigurationProto} returns this
	*/
	proto.onnx.DeviceConfigurationProto.prototype.clearNumDevices = function() {
		return jspb.Message.setField(this, 2, void 0);
	};
	/**
	* Returns whether this field is set.
	* @return {boolean}
	*/
	proto.onnx.DeviceConfigurationProto.prototype.hasNumDevices = function() {
		return jspb.Message.getField(this, 2) != null;
	};
	/**
	...
	* @return {!Array<string>}
	*/
	proto.onnx.DeviceConfigurationProto.prototype.getDeviceList = function() {
	...
	* @return {!proto.onnx.DeviceConfigurationProto} returns this
	*/
	proto.onnx.DeviceConfigurationProto.prototype.setDeviceList = function(value) {
		return jspb.Message.setField(this, 3, value || []);
	};
	/**
	* @param {string} value
	...
	* @return {!proto.onnx.DeviceConfigurationProto} returns this
	*/
	proto.onnx.DeviceConfigurationProto.prototype.addDevice = function(value, opt_index) {
	...
	* @return {!proto.onnx.DeviceConfigurationProto} returns this
	*/
	proto.onnx.DeviceConfigurationProto.prototype.clearDeviceList = function() {
		return this.setDeviceList([]);
	};
	if (jspb.Message.GENERATE_TO_OBJECT) {
		/**
		...
		*/
		proto.onnx.StringStringEntryProto.toObject = function(includeInstance, msg) {
			var f, obj = {
				key: (f = jspb.Message.getField(msg, 1)) == null ? void 0 : f,
				value: (f = jspb.Message.getField(msg, 2)) == null ? void 0 : f
			};
			if (includeInstance) obj.$jspbMessageInstance = msg;
			return obj;
		};
	...
	if (jspb.Message.GENERATE_TO_OBJECT) {
		...
		*/
		proto.onnx.TensorAnnotation.toObject = function(includeInstance, msg) {
			var f, obj = {
				tensorName: (f = jspb.Message.getField(msg, 1)) == null ? void 0 : f,
				quantParameterTensorNamesList: jspb.Message.toObjectList(msg.getQuantParameterTensorNamesList(), proto.onnx.StringStringEntryProto.toObject, includeInstance)
			};
			if (includeInstance) obj.$jspbMessageInstance = msg;
			return obj;
		};
	...
	*/
	proto.onnx.TensorAnnotation.serializeBinaryToWriter = function(message, writer) {
		...
		if (f.length > 0) writer.writeRepeatedMessage(2, f, proto.onnx.StringStringEntryProto.serializeBinaryToWriter);
	};
	/**
	* optional string tensor_name = 1;
	* @return {string}
	...
	*/
	proto.onnx.TensorAnnotation.prototype.getQuantParameterTensorNamesList = function() {
		return jspb.Message.getRepeatedWrapperField(this, proto.onnx.StringStringEntryProto, 2);
	};
	/**
	* @param {!Array<!proto.onnx.StringStringEntryProto>} value
	* @return {!proto.onnx.TensorAnnotation} returns this
	...
	* @const
	*/
	proto.onnx.GraphProto.repeatedFields_ = [
		1,
		5,
		15,
		11,
	...
	if (jspb.Message.GENERATE_TO_OBJECT) {
		...
		*/
		proto.onnx.GraphProto.toObject = function(includeInstance, msg) {
			var f, obj = {
				nodeList: jspb.Message.toObjectList(msg.getNodeList(), proto.onnx.NodeProto.toObject, includeInstance),
				name: (f = jspb.Message.getField(msg, 2)) == null ? void 0 : f,
				initializerList: jspb.Message.toObjectList(msg.getInitializerList(), proto.onnx.TensorProto.toObject, includeInstance),
				sparseInitializerList: jspb.Message.toObjectList(msg.getSparseInitializerList(), proto.onnx.SparseTensorProto.toObject, includeInstance),
				docString: (f = jspb.Message.getField(msg, 10)) == null ? void 0 : f,
				inputList: jspb.Message.toObjectList(msg.getInputList(), proto.onnx.ValueInfoProto.toObject, includeInstance),
				outputList: jspb.Message.toObjectList(msg.getOutputList(), proto.onnx.ValueInfoProto.toObject, includeInstance),
				valueInfoList: jspb.Message.toObjectList(msg.getValueInfoList(), proto.onnx.ValueInfoProto.toObject, includeInstance),
				quantizationAnnotationList: jspb.Message.toObjectList(msg.getQuantizationAnnotationList(), proto.onnx.TensorAnnotation.toObject, includeInstance),
				metadataPropsList: jspb.Message.toObjectList(msg.getMetadataPropsList(), proto.onnx.StringStringEntryProto.toObject, includeInstance)
			};
			if (includeInstance) obj.$jspbMessageInstance = msg;
			return obj;
	...
	*/
	proto.onnx.GraphProto.serializeBinaryToWriter = function(message, writer) {
		...
		if (f.length > 0) writer.writeRepeatedMessage(1, f, proto.onnx.NodeProto.serializeBinaryToWriter);
		f = jspb.Message.getField(message, 2);
		if (f != null) writer.writeString(2, f);
		f = message.getInitializerList();
		if (f.length > 0) writer.writeRepeatedMessage(5, f, proto.onnx.TensorProto.serializeBinaryToWriter);
		f = message.getSparseInitializerList();
		if (f.length > 0) writer.writeRepeatedMessage(15, f, proto.onnx.SparseTensorProto.serializeBinaryToWriter);
		f = jspb.Message.getField(message, 10);
		if (f != null) writer.writeString(10, f);
		f = message.getInputList();
		if (f.length > 0) writer.writeRepeatedMessage(11, f, proto.onnx.ValueInfoProto.serializeBinaryToWriter);
		f = message.getOutputList();
		if (f.length > 0) writer.writeRepeatedMessage(12, f, proto.onnx.ValueInfoProto.serializeBinaryToWriter);
		f = message.getValueInfoList();
		if (f.length > 0) writer.writeRepeatedMessage(13, f, proto.onnx.ValueInfoProto.serializeBinaryToWriter);
		f = message.getQuantizationAnnotationList();
		if (f.length > 0) writer.writeRepeatedMessage(14, f, proto.onnx.TensorAnnotation.serializeBinaryToWriter);
		f = message.getMetadataPropsList();
		if (f.length > 0) writer.writeRepeatedMessage(16, f, proto.onnx.StringStringEntryProto.serializeBinaryToWriter);
	};
	/**
	...
	*/
	proto.onnx.GraphProto.prototype.getNodeList = function() {
		return jspb.Message.getRepeatedWrapperField(this, proto.onnx.NodeProto, 1);
	};
	/**
	...
	*/
	proto.onnx.GraphProto.prototype.getInitializerList = function() {
		return jspb.Message.getRepeatedWrapperField(this, proto.onnx.TensorProto, 5);
	};
	/**
	* @param {!Array<!proto.onnx.TensorProto>} value
	* @return {!proto.onnx.GraphProto} returns this
	...
	*/
	proto.onnx.GraphProto.prototype.getSparseInitializerList = function() {
		return jspb.Message.getRepeatedWrapperField(this, proto.onnx.SparseTensorProto, 15);
	};
	/**
	* @param {!Array<!proto.onnx.SparseTensorProto>} value
	* @return {!proto.onnx.GraphProto} returns this
	...
	*/
	proto.onnx.GraphProto.prototype.clearDocString = function() {
		return jspb.Message.setField(this, 10, void 0);
	};
	/**
	* Returns whether this field is set.
	* @return {boolean}
	...
	*/
	proto.onnx.GraphProto.prototype.getInputList = function() {
		return jspb.Message.getRepeatedWrapperField(this, proto.onnx.ValueInfoProto, 11);
	};
	/**
	...
	*/
	proto.onnx.GraphProto.prototype.getOutputList = function() {
		return jspb.Message.getRepeatedWrapperField(this, proto.onnx.ValueInfoProto, 12);
	};
	/**
	* @param {!Array<!proto.onnx.ValueInfoProto>} value
	* @return {!proto.onnx.GraphProto} returns this
	...
	*/
	proto.onnx.GraphProto.prototype.getValueInfoList = function() {
		return jspb.Message.getRepeatedWrapperField(this, proto.onnx.ValueInfoProto, 13);
	};
	/**
	* @param {!Array<!proto.onnx.ValueInfoProto>} value
	* @return {!proto.onnx.GraphProto} returns this
	...
	*/
	proto.onnx.GraphProto.prototype.getQuantizationAnnotationList = function() {
		return jspb.Message.getRepeatedWrapperField(this, proto.onnx.TensorAnnotation, 14);
	};
	/**
	...
	*/
	proto.onnx.GraphProto.prototype.getMetadataPropsList = function() {
		return jspb.Message.getRepeatedWrapperField(this, proto.onnx.StringStringEntryProto, 16);
	};
	/**
	* @param {!Array<!proto.onnx.StringStringEntryProto>} value
	* @return {!proto.onnx.GraphProto} returns this
	...
	* @const
	*/
	proto.onnx.TensorProto.repeatedFields_ = [
		1,
		4,
		5,
		6,
	...
	if (jspb.Message.GENERATE_TO_OBJECT) {
		...
		*/
		proto.onnx.TensorProto.toObject = function(includeInstance, msg) {
			var f, obj = {
				dimsList: (f = jspb.Message.getRepeatedField(msg, 1)) == null ? void 0 : f,
				dataType: (f = jspb.Message.getField(msg, 2)) == null ? void 0 : f,
				segment: (f = msg.getSegment()) && proto.onnx.TensorProto.Segment.toObject(includeInstance, f),
				floatDataList: (f = jspb.Message.getRepeatedFloatingPointField(msg, 4)) == null ? void 0 : f,
				int32DataList: (f = jspb.Message.getRepeatedField(msg, 5)) == null ? void 0 : f,
				stringDataList: msg.getStringDataList_asB64(),
				int64DataList: (f = jspb.Message.getRepeatedField(msg, 7)) == null ? void 0 : f,
				name: (f = jspb.Message.getField(msg, 8)) == null ? void 0 : f,
				docString: (f = jspb.Message.getField(msg, 12)) == null ? void 0 : f,
				rawData: msg.getRawData_asB64(),
				externalDataList: jspb.Message.toObjectList(msg.getExternalDataList(), proto.onnx.StringStringEntryProto.toObject, includeInstance),
				dataLocation: (f = jspb.Message.getField(msg, 14)) == null ? void 0 : f,
				doubleDataList: (f = jspb.Message.getRepeatedFloatingPointField(msg, 10)) == null ? void 0 : f,
				uint64DataList: (f = jspb.Message.getRepeatedField(msg, 11)) == null ? void 0 : f,
				metadataPropsList: jspb.Message.toObjectList(msg.getMetadataPropsList(), proto.onnx.StringStringEntryProto.toObject, includeInstance)
			};
			if (includeInstance) obj.$jspbMessageInstance = msg;
			return obj;
	...
	proto.onnx.TensorProto.deserializeBinaryFromReader = function(msg, reader) {
		while (reader.nextField()) {
			...
			switch (reader.getFieldNumber()) {
				case 1:
					var values = reader.isDelimited() ? reader.readPackedInt64() : [reader.readInt64()];
					for (var i = 0; i < values.length; i++) msg.addDims(values[i]);
					break;
				case 2:
					var value = reader.readInt32();
				...
				case 4:
					var values = reader.isDelimited() ? reader.readPackedFloat() : [reader.readFloat()];
					for (var i = 0; i < values.length; i++) msg.addFloatData(values[i]);
					break;
				case 5:
					var values = reader.isDelimited() ? reader.readPackedInt32() : [reader.readInt32()];
					for (var i = 0; i < values.length; i++) msg.addInt32Data(values[i]);
					break;
				case 6:
					var value = reader.readBytes();
				...
				case 7:
					var values = reader.isDelimited() ? reader.readPackedInt64() : [reader.readInt64()];
					for (var i = 0; i < values.length; i++) msg.addInt64Data(values[i]);
					break;
				case 8:
					var value = reader.readString();
					msg.setName(value);
				...
				case 14:
					...
					break;
				case 10:
					var values = reader.isDelimited() ? reader.readPackedDouble() : [reader.readDouble()];
					for (var i = 0; i < values.length; i++) msg.addDoubleData(values[i]);
					break;
				case 11:
					var values = reader.isDelimited() ? reader.readPackedUint64() : [reader.readUint64()];
					for (var i = 0; i < values.length; i++) msg.addUint64Data(values[i]);
					break;
				case 16:
					var value = new proto.onnx.StringStringEntryProto();
					reader.readMessage(value, proto.onnx.StringStringEntryProto.deserializeBinaryFromReader);
	...
	*/
	proto.onnx.TensorProto.serializeBinaryToWriter = function(message, writer) {
		...
		if (f.length > 0) writer.writeRepeatedInt64(1, f);
		f = jspb.Message.getField(message, 2);
		if (f != null) writer.writeInt32(2, f);
		f = message.getSegment();
		if (f != null) writer.writeMessage(3, f, proto.onnx.TensorProto.Segment.serializeBinaryToWriter);
		f = message.getFloatDataList();
		if (f.length > 0) writer.writePackedFloat(4, f);
		f = message.getInt32DataList();
		if (f.length > 0) writer.writePackedInt32(5, f);
		f = message.getStringDataList_asU8();
		if (f.length > 0) writer.writeRepeatedBytes(6, f);
		f = message.getInt64DataList();
		if (f.length > 0) writer.writePackedInt64(7, f);
		f = jspb.Message.getField(message, 8);
		if (f != null) writer.writeString(8, f);
		f = jspb.Message.getField(message, 12);
		if (f != null) writer.writeString(12, f);
		f = jspb.Message.getField(message, 9);
		if (f != null) writer.writeBytes(9, f);
		f = message.getExternalDataList();
		if (f.length > 0) writer.writeRepeatedMessage(13, f, proto.onnx.StringStringEntryProto.serializeBinaryToWriter);
		f = jspb.Message.getField(message, 14);
		if (f != null) writer.writeEnum(14, f);
		f = message.getDoubleDataList();
		if (f.length > 0) writer.writePackedDouble(10, f);
		f = message.getUint64DataList();
		if (f.length > 0) writer.writePackedUint64(11, f);
		f = message.getMetadataPropsList();
		if (f.length > 0) writer.writeRepeatedMessage(16, f, proto.onnx.StringStringEntryProto.serializeBinaryToWriter);
	};
	/**
	...
	if (jspb.Message.GENERATE_TO_OBJECT) {
		...
		*/
		proto.onnx.TensorProto.Segment.toObject = function(includeInstance, msg) {
			var f, obj = {
				begin: (f = jspb.Message.getField(msg, 1)) == null ? void 0 : f,
				end: (f = jspb.Message.getField(msg, 2)) == null ? void 0 : f
			};
			if (includeInstance) obj.$jspbMessageInstance = msg;
			return obj;
		};
	...
	*/
	proto.onnx.TensorProto.Segment.serializeBinaryToWriter = function(message, writer) {
		...
		if (f != null) writer.writeInt64(1, f);
		f = jspb.Message.getField(message, 2);
		if (f != null) writer.writeInt64(2, f);
	};
	/**
	...
	*/
	proto.onnx.TensorProto.prototype.getSegment = function() {
		return jspb.Message.getWrapperField(this, proto.onnx.TensorProto.Segment, 3);
	};
	/**
	...
	*/
	proto.onnx.TensorProto.prototype.getStringDataList_asB64 = function() {
		return jspb.Message.bytesListAsB64(this.getStringDataList());
	};
	/**
	* repeated bytes string_data = 6;
	* Note that Uint8Array is not supported on all browsers.
	...
	*/
	proto.onnx.TensorProto.prototype.getStringDataList_asU8 = function() {
		return jspb.Message.bytesListAsU8(this.getStringDataList());
	};
	/**
	* @param {!(Array<!Uint8Array>|Array<string>)} value
	* @return {!proto.onnx.TensorProto} returns this
	...
	*/
	proto.onnx.TensorProto.prototype.getRawData_asB64 = function() {
		return jspb.Message.bytesAsB64(this.getRawData());
	};
	/**
	* optional bytes raw_data = 9;
	* Note that Uint8Array is not supported on all browsers.
	...
	*/
	proto.onnx.TensorProto.prototype.getRawData_asU8 = function() {
		return jspb.Message.bytesAsU8(this.getRawData());
	};
	/**
	* @param {!(string|Uint8Array)} value
	* @return {!proto.onnx.TensorProto} returns this
	...
	*/
	proto.onnx.TensorProto.prototype.getExternalDataList = function() {
		return jspb.Message.getRepeatedWrapperField(this, proto.onnx.StringStringEntryProto, 13);
	};
	/**
	* @param {!Array<!proto.onnx.StringStringEntryProto>} value
	* @return {!proto.onnx.TensorProto} returns this
	...
	*/
	proto.onnx.TensorProto.prototype.getDoubleDataList = function() {
		return jspb.Message.getRepeatedFloatingPointField(this, 10);
	};
	/**
	* @param {!Array<number>} value
	* @return {!proto.onnx.TensorProto} returns this
		...
		*/
		proto.onnx.SparseTensorProto.toObject = function(includeInstance, msg) {
			var f, obj = {
				...
				dimsList: (f = jspb.Message.getRepeatedField(msg, 3)) == null ? void 0 : f
			};
			if (includeInstance) obj.$jspbMessageInstance = msg;
			return obj;
		};
	...
	*/
	proto.onnx.SparseTensorProto.serializeBinaryToWriter = function(message, writer) {
		var f = void 0;
		f = message.getValues();
		if (f != null) writer.writeMessage(1, f, proto.onnx.TensorProto.serializeBinaryToWriter);
		f = message.getIndices();
		if (f != null) writer.writeMessage(2, f, proto.onnx.TensorProto.serializeBinaryToWriter);
		f = message.getDimsList();
		if (f.length > 0) writer.writeRepeatedInt64(3, f);
	};
	/**
	...
	*/
	proto.onnx.SparseTensorProto.prototype.getValues = function() {
		return jspb.Message.getWrapperField(this, proto.onnx.TensorProto, 1);
	};
	/**
	* @param {?proto.onnx.TensorProto|undefined} value
	...
	*/
	proto.onnx.SparseTensorProto.prototype.getIndices = function() {
		return jspb.Message.getWrapperField(this, proto.onnx.TensorProto, 2);
	};
	/**
	* @param {?proto.onnx.TensorProto|undefined} value
	* @return {!proto.onnx.SparseTensorProto} returns this
	...
	if (jspb.Message.GENERATE_TO_OBJECT) {
		...
		*/
		proto.onnx.TensorShapeProto.toObject = function(includeInstance, msg) {
			var obj = { dimList: jspb.Message.toObjectList(msg.getDimList(), proto.onnx.TensorShapeProto.Dimension.toObject, includeInstance) };
			if (includeInstance) obj.$jspbMessageInstance = msg;
			return obj;
		};
	}
	...
	*/
	proto.onnx.TensorShapeProto.serializeBinaryToWriter = function(message, writer) {
		...
		if (f.length > 0) writer.writeRepeatedMessage(1, f, proto.onnx.TensorShapeProto.Dimension.serializeBinaryToWriter);
	};
	/**
	* Oneof group definitions for this message. Each group defines the field
	* numbers belonging to that group. When of these fields' value is set, all
	...
	*/
	proto.onnx.TensorShapeProto.Dimension.prototype.getValueCase = function() {
		return jspb.Message.computeOneofCase(this, proto.onnx.TensorShapeProto.Dimension.oneofGroups_[0]);
	};
	if (jspb.Message.GENERATE_TO_OBJECT) {
		/**
		* Creates an object representation of this proto.
		...
		*/
		proto.onnx.TensorShapeProto.Dimension.toObject = function(includeInstance, msg) {
			var f, obj = {
				dimValue: (f = jspb.Message.getField(msg, 1)) == null ? void 0 : f,
				dimParam: (f = jspb.Message.getField(msg, 2)) == null ? void 0 : f,
				denotation: (f = jspb.Message.getField(msg, 3)) == null ? void 0 : f
			};
			if (includeInstance) obj.$jspbMessageInstance = msg;
			return obj;
		};
	...
	*/
	proto.onnx.TensorShapeProto.Dimension.prototype.clearDimValue = function() {
		return jspb.Message.setOneofField(this, 1, proto.onnx.TensorShapeProto.Dimension.oneofGroups_[0], void 0);
	};
	/**
	* Returns whether this field is set.
	* @return {boolean}
	...
	*/
	proto.onnx.TensorShapeProto.Dimension.prototype.clearDimParam = function() {
		return jspb.Message.setOneofField(this, 2, proto.onnx.TensorShapeProto.Dimension.oneofGroups_[0], void 0);
	};
	/**
	* Returns whether this field is set.
	* @return {boolean}
	...
	*/
	proto.onnx.TensorShapeProto.prototype.getDimList = function() {
		return jspb.Message.getRepeatedWrapperField(this, proto.onnx.TensorShapeProto.Dimension, 1);
	};
	/**
	...
	* @const
	*/
	proto.onnx.TypeProto.oneofGroups_ = [[
		1,
		4,
		5,
		9,
	...
	*/
	proto.onnx.TypeProto.prototype.getValueCase = function() {
		return jspb.Message.computeOneofCase(this, proto.onnx.TypeProto.oneofGroups_[0]);
	};
	if (jspb.Message.GENERATE_TO_OBJECT) {
		/**
		* Creates an object representation of this proto.
		...
		*/
		proto.onnx.TypeProto.toObject = function(includeInstance, msg) {
			var f, obj = {
				...
				denotation: (f = jspb.Message.getField(msg, 6)) == null ? void 0 : f
			};
			if (includeInstance) obj.$jspbMessageInstance = msg;
			return obj;
		};
	...
	*/
	proto.onnx.TypeProto.serializeBinaryToWriter = function(message, writer) {
		...
		if (f != null) writer.writeMessage(1, f, proto.onnx.TypeProto.Tensor.serializeBinaryToWriter);
		f = message.getSequenceType();
		if (f != null) writer.writeMessage(4, f, proto.onnx.TypeProto.Sequence.serializeBinaryToWriter);
		f = message.getMapType();
		if (f != null) writer.writeMessage(5, f, proto.onnx.TypeProto.Map.serializeBinaryToWriter);
		f = message.getOptionalType();
		if (f != null) writer.writeMessage(9, f, proto.onnx.TypeProto.Optional.serializeBinaryToWriter);
		f = message.getSparseTensorType();
		if (f != null) writer.writeMessage(8, f, proto.onnx.TypeProto.SparseTensor.serializeBinaryToWriter);
		f = jspb.Message.getField(message, 6);
		if (f != null) writer.writeString(6, f);
	};
	if (jspb.Message.GENERATE_TO_OBJECT) {
		...
		*/
		proto.onnx.TypeProto.Tensor.toObject = function(includeInstance, msg) {
			var f, obj = {
				elemType: (f = jspb.Message.getField(msg, 1)) == null ? void 0 : f,
	...
	*/
	proto.onnx.TypeProto.Tensor.serializeBinaryToWriter = function(message, writer) {
		var f = void 0;
		f = jspb.Message.getField(message, 1);
		if (f != null) writer.writeInt32(1, f);
		f = message.getShape();
		if (f != null) writer.writeMessage(2, f, proto.onnx.TensorShapeProto.serializeBinaryToWriter);
	};
	/**
	...
	*/
	proto.onnx.TypeProto.Tensor.prototype.getShape = function() {
		return jspb.Message.getWrapperField(this, proto.onnx.TensorShapeProto, 2);
	};
	/**
	...
	if (jspb.Message.GENERATE_TO_OBJECT) {
		...
		*/
		proto.onnx.TypeProto.Sequence.toObject = function(includeInstance, msg) {
			var f, obj = { elemType: (f = msg.getElemType()) && proto.onnx.TypeProto.toObject(includeInstance, f) };
			if (includeInstance) obj.$jspbMessageInstance = msg;
			return obj;
		};
	}
	...
	*/
	proto.onnx.TypeProto.Sequence.serializeBinaryToWriter = function(message, writer) {
		...
		if (f != null) writer.writeMessage(1, f, proto.onnx.TypeProto.serializeBinaryToWriter);
	};
	/**
	...
	*/
	proto.onnx.TypeProto.Sequence.prototype.getElemType = function() {
		return jspb.Message.getWrapperField(this, proto.onnx.TypeProto, 1);
	};
	/**
	* @param {?proto.onnx.TypeProto|undefined} value
	...
	*/
	proto.onnx.TypeProto.Sequence.prototype.clearElemType = function() {
		return this.setElemType(void 0);
	};
	/**
	* Returns whether this field is set.
	* @return {boolean}
	...
	if (jspb.Message.GENERATE_TO_OBJECT) {
		...
		*/
		proto.onnx.TypeProto.Map.toObject = function(includeInstance, msg) {
			var f, obj = {
				keyType: (f = jspb.Message.getField(msg, 1)) == null ? void 0 : f,
	...
	*/
	proto.onnx.TypeProto.Map.prototype.clearValueType = function() {
		return this.setValueType(void 0);
	};
	/**
	* Returns whether this field is set.
	* @return {boolean}
	...
	*/
	proto.onnx.TypeProto.prototype.getTensorType = function() {
		return jspb.Message.getWrapperField(this, proto.onnx.TypeProto.Tensor, 1);
	};
	/**
	...
	*/
	proto.onnx.TypeProto.prototype.clearTensorType = function() {
		return this.setTensorType(void 0);
	};
	/**
	* Returns whether this field is set.
	* @return {boolean}
	...
	*/
	proto.onnx.TypeProto.prototype.getSequenceType = function() {
		return jspb.Message.getWrapperField(this, proto.onnx.TypeProto.Sequence, 4);
	};
	/**
	...
	*/
	proto.onnx.TypeProto.prototype.clearSequenceType = function() {
		return this.setSequenceType(void 0);
	};
	/**
	* Returns whether this field is set.
	* @return {boolean}
	...
	*/
	proto.onnx.TypeProto.prototype.getMapType = function() {
		return jspb.Message.getWrapperField(this, proto.onnx.TypeProto.Map, 5);
	};
	/**
	...
	*/
	proto.onnx.TypeProto.prototype.getOptionalType = function() {
		return jspb.Message.getWrapperField(this, proto.onnx.TypeProto.Optional, 9);
	};
	/**
	...
	*/
	proto.onnx.TypeProto.prototype.clearOptionalType = function() {
		return this.setOptionalType(void 0);
	};
	/**
	* Returns whether this field is set.
	* @return {boolean}
	...
	*/
	proto.onnx.TypeProto.prototype.getSparseTensorType = function() {
		return jspb.Message.getWrapperField(this, proto.onnx.TypeProto.SparseTensor, 8);
	};
	/**
	...
	*/
	proto.onnx.TypeProto.prototype.clearSparseTensorType = function() {
		return this.setSparseTensorType(void 0);
	};
	/**
	* Returns whether this field is set.
	* @return {boolean}
	...
	if (jspb.Message.GENERATE_TO_OBJECT) {
		...
		*/
		proto.onnx.OperatorSetIdProto.toObject = function(includeInstance, msg) {
			var f, obj = {
				domain: (f = jspb.Message.getField(msg, 1)) == null ? void 0 : f,
				version: (f = jspb.Message.getField(msg, 2)) == null ? void 0 : f
			};
			if (includeInstance) obj.$jspbMessageInstance = msg;
			return obj;
		};
	...
	* @const
	*/
	proto.onnx.FunctionProto.repeatedFields_ = [
		4,
		5,
		6,
		11,
	...
	if (jspb.Message.GENERATE_TO_OBJECT) {
		...
		*/
		proto.onnx.FunctionProto.toObject = function(includeInstance, msg) {
			var f, obj = {
				name: (f = jspb.Message.getField(msg, 1)) == null ? void 0 : f,
				inputList: (f = jspb.Message.getRepeatedField(msg, 4)) == null ? void 0 : f,
				outputList: (f = jspb.Message.getRepeatedField(msg, 5)) == null ? void 0 : f,
				attributeList: (f = jspb.Message.getRepeatedField(msg, 6)) == null ? void 0 : f,
				attributeProtoList: jspb.Message.toObjectList(msg.getAttributeProtoList(), proto.onnx.AttributeProto.toObject, includeInstance),
				nodeList: jspb.Message.toObjectList(msg.getNodeList(), proto.onnx.NodeProto.toObject, includeInstance),
				docString: (f = jspb.Message.getField(msg, 8)) == null ? void 0 : f,
				opsetImportList: jspb.Message.toObjectList(msg.getOpsetImportList(), proto.onnx.OperatorSetIdProto.toObject, includeInstance),
				domain: (f = jspb.Message.getField(msg, 10)) == null ? void 0 : f,
				overload: (f = jspb.Message.getField(msg, 13)) == null ? void 0 : f,
				valueInfoList: jspb.Message.toObjectList(msg.getValueInfoList(), proto.onnx.ValueInfoProto.toObject, includeInstance),
				metadataPropsList: jspb.Message.toObjectList(msg.getMetadataPropsList(), proto.onnx.StringStringEntryProto.toObject, includeInstance)
			};
			if (includeInstance) obj.$jspbMessageInstance = msg;
	...
	*/
	proto.onnx.FunctionProto.serializeBinaryToWriter = function(message, writer) {
		...
		f = message.getAttributeList();
		if (f.length > 0) writer.writeRepeatedString(6, f);
		f = message.getAttributeProtoList();
		if (f.length > 0) writer.writeRepeatedMessage(11, f, proto.onnx.AttributeProto.serializeBinaryToWriter);
		f = message.getNodeList();
		if (f.length > 0) writer.writeRepeatedMessage(7, f, proto.onnx.NodeProto.serializeBinaryToWriter);
		f = jspb.Message.getField(message, 8);
		if (f != null) writer.writeString(8, f);
		f = message.getOpsetImportList();
		if (f.length > 0) writer.writeRepeatedMessage(9, f, proto.onnx.OperatorSetIdProto.serializeBinaryToWriter);
		f = jspb.Message.getField(message, 10);
		if (f != null) writer.writeString(10, f);
		f = jspb.Message.getField(message, 13);
		if (f != null) writer.writeString(13, f);
	...
	*/
	proto.onnx.FunctionProto.prototype.getAttributeProtoList = function() {
		return jspb.Message.getRepeatedWrapperField(this, proto.onnx.AttributeProto, 11);
	};
	/**
	* @param {!Array<!proto.onnx.AttributeProto>} value
	* @return {!proto.onnx.FunctionProto} returns this
	...
	*/
	proto.onnx.FunctionProto.prototype.getNodeList = function() {
		return jspb.Message.getRepeatedWrapperField(this, proto.onnx.NodeProto, 7);
	};
	/**
	* @param {!Array<!proto.onnx.NodeProto>} value
	* @return {!proto.onnx.FunctionProto} returns this
	...
	*/
	proto.onnx.FunctionProto.prototype.getOpsetImportList = function() {
		return jspb.Message.getRepeatedWrapperField(this, proto.onnx.OperatorSetIdProto, 9);
	};
	/**
	* @param {!Array<!proto.onnx.OperatorSetIdProto>} value
	* @return {!proto.onnx.FunctionProto} returns this
...
//#endregion
export default require_onnx_pb();
