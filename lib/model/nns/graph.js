...
class Node {
	 ...
	 * @param {(string | number)[]} input Input node names	 * @param {string[]} input Input node names
...
export default class ComputationalGraph {
	 ...
	 * @param {(string | number)[] | string | number} [inputs] Input node names for the added layer
	 */
