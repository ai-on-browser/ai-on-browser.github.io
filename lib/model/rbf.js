...
export default class RadialBasisFunctionNetwork {
	...
	/**
	 * @param {'linear' | 'gaussian' | 'multiquadric' | 'inverse quadratic' | 'inverse multiquadric' | 'thin plate' | 'bump'} [rbf=linear] RBF name
	 * @param {number} [e=1] Tuning parameter
	 * @param {number} [l=0] Regularization parameter
	 */
