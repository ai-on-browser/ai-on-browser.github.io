...
class HierarchyClustering {
	/**
	 * Constructor
	 * @param {'euclid' | 'manhattan' | 'chebyshev'} metric
	 */
...
/**
 * Complete linkage hierarchy clustering
 */
export class CompleteLinkageHierarchyClustering extends HierarchyClustering {
	/**
	 * Returns a distance between two nodes.
	 * @param {Tree} c1
	 * @param {Tree} c2
...
/**
 * Single linkage hierarchy clustering
 */
export class SingleLinkageHierarchyClustering extends HierarchyClustering {
	/**
	 * Returns a distance between two nodes.
	 * @param {Tree} c1
	 * @param {Tree} c2
...
/**
 * Group average hierarchy clustering
 */
export class GroupAverageHierarchyClustering extends HierarchyClustering {
	/**
	 * Returns a distance between two nodes.
	 * @param {Tree} c1
	 * @param {Tree} c2
...
/**
 * Ward's hierarchy clustering
 */
export class WardsHierarchyClustering extends HierarchyClustering {
	/**
	 * Returns a distance between two nodes.
	 * @param {Tree} c1
	 * @param {Tree} c2
...
/**
 * Centroid hierarchy clustering
 */
export class CentroidHierarchyClustering extends HierarchyClustering {
	/**
	 * Returns a distance between two nodes.
	 * @param {Tree} c1
	 * @param {Tree} c2
...
/**
 * Weighted average hierarchy clustering
 */
export class WeightedAverageHierarchyClustering extends HierarchyClustering {
	/**
	 * Returns a distance between two nodes.
	 * @param {Tree} c1
	 * @param {Tree} c2
...
/**
 * Median hierarchy clustering
 */
export class MedianHierarchyClustering extends HierarchyClustering {
	/**
	 * Returns a distance between two nodes.
	 * @param {Tree} c1
	 * @param {Tree} c2
