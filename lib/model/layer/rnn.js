...
import { NeuralnetworkLayers } from '../neuralnetwork.js'
...
export default class RNNLayer extends Layer {
	constructor({
		...
		this._rest = rest
		if (activation) {
			this._activation = new NeuralnetworkLayers[activation](rest)
		}
		if (recurrent_activation) {
			this._recurrent_activation = new NeuralnetworkLayers[recurrent_activation](rest)
		}
