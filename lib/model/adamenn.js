...
export default class ADAMENN {
	 ...
	 * @param {number} [k1=3] The number of neighbors in N1 for estimation
	 ...
	 * @param {number} [k=3] The number of neighbors in the final nearest neighbor rule
	 * @param {number} [c=0.5] The positive factor for the exponential weighting scheme
	 */
