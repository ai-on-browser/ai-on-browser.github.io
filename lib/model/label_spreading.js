...
export default class LabelSpreading {
	...
	/**
	 * @param {number} [alpha=0.2] Clamping factor
	 * @param {'rbf' | 'knn'} [method=rbf] Method name
	 * @param {number} [sigma=0.1] Sigma of normal distribution
	 * @param {number} [k=Infinity] Number of neighborhoods
	 */
