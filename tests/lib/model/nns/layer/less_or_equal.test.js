...
import LessOrEqualLayer from '../../../../../lib/model/nns/layer/less_or_equal.js'

describe('layer', () => {
	test('construct', () => {
		const layer = new LessOrEqualLayer({})
	...
	test('fromObject', () => {
		const layer = LessOrEqualLayer.fromObject({ type: 'less_or_equal' })
		expect(layer).toBeInstanceOf(LessOrEqualLayer)
	})
})
