...
describe('reinforcement learning', () => {
	...
	test('initialize', async () => {
		...
		await modelSelectBox.selectOption('policy_gradient')
		...
		const learningrate = await buttons.waitForSelector('input:nth-of-type(4)')
		await expect(learningrate.getAttribute('value')).resolves.toBe('0.1')
	})
