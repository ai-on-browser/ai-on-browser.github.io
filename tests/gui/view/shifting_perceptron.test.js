...
describe('classification', () => {
	...
	test('initialize', async () => {
		...
		await modelSelectBox.selectOption('shifting_perceptron')
		...
		const lambda = await buttons.waitForSelector('input:nth-of-type(1)')
		await expect((await lambda.getProperty('value')).jsonValue()).resolves.toBe('1')
