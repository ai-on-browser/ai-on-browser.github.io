...
describe('classification', () => {
	...
	test('initialize', async () => {
		...
		modelSelectBox.select('perceptron')
		...
		const average = await buttons.waitForSelector('[name=average]')
		await expect((await average.getProperty('value')).jsonValue()).resolves.toBe('')
