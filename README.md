...
```HTML
<script type="module">
    import dam from 'https://cdn.jsdelivr.net/npm/@ai-on-browser/data-analysis-models@0.9.0/lib/index.min.js';
    // Do something
</script>
```
...
| anomaly detection | Percentile, MAD, Tukey's fences, Grubbs's test, Thompson test, Tietjen Moore test, Generalized ESD, Hotelling, MT, MCD, k-nearest neighbor, LOF, COF, ODIN, LDOF, INFLO, LOCI, LoOP, LDF, KDEOS, RDOS, PCA, OCSVM, KDE, GMM, Isolation forest, Autoencoder, GAN |
