...
| task | model |
|------|-------|
| clustering | k-means, k-means++, k-medois, x-means, LBG, ISODATA, hierarchy (complete linkage, single linkage, group average, Ward's, centroid, weighted average, median), DIANA, mean shift, DBSCAN, OPTICS, CLARANS, BIRCH, GMM, VBGMM, affinity propagation, spectral clustering, SOM, neural gas, LVQ, autoencoder |
