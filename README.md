...
| anomaly detection | Percentile, MAD, Tukey's fences, Grubbs's test, Thompson test, Tietjen Moore test, Generalized ESD, Hotelling, MT, MCD, k-nearest neighbor, LOF, COF, ODIN, LDOF, LOCI, PCA, OCSVM, KDE, GMM, Isolation forest, Autoencoder, GAN |
