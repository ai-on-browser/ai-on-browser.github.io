...
```HTML
<script type="module">
    import dam from 'https://cdn.jsdelivr.net/npm/@ai-on-browser/data-analysis-models@0.24.0/lib/index.min.js';
    // Do something
</script>
```
