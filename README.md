...
| interpolation | Nearest neighbor, IDW, Linear, Logarithmic, Cosine, (Inverse) Smoothstep, Cubic, (Centripetal) Catmull-Rom, Hermit, Polynomial, Lagrange, Spline, RBF Network, Akima |
